...
public class IssuesTests_6000_6499 extends CompilerTests {
    ...
    public void testBug6037() throws Throwable {
        ProcessBuilder pb = new ProcessBuilder(script(), "compile", "--src=test/src", "com.redhat.ceylon.compiler.java.test.issues.bug60xx.bug6037");
        pb.inheritIO();
        Process p = pb.start();
    ...
    @Test
    public void testBug6370() {
        Assume.assumeTrue("Runs on JDK8", JDKUtils.jdk == JDKUtils.JDK.JDK8
                || JDKUtils.jdk == JDKUtils.JDK.JDK9);
        compile("bug63xx/Bug6370.ceylon");
    }
