...
public class ModelLoaderTests extends CompilerTests {
    ...
    public void bogusModelAnnotationsTopLevelAttribute(){
        ...
        assertErrors("bogusTopLevelAttributeUser",
                ...
                new CompilerError(3, "could not determine type of function or value reference: the type of 'bogusTopLevelAttributeNoGetter' is not known - Error while loading the com.redhat.ceylon.compiler.java.test.model/1 module:\n"+
                        "   Error while resolving toplevel attribute com.redhat.ceylon.compiler.java.test.model::bogusTopLevelAttributeNoGetter: getter method missing"),
                new CompilerError(4, "could not determine type of function or value reference: the type of 'bogusTopLevelAttributeMissingType' is not known - Error while resolving type of toplevel attribute for com.redhat.ceylon.compiler.java.test.model::bogusTopLevelAttributeMissingType: Could not find type 'com.redhat.ceylon.compiler.java.test.model.MissingType'"),
                new CompilerError(5, "could not determine type of function or value reference: the type of 'bogusTopLevelAttributeInvalidType' is not known - Error while parsing type of toplevel attribute for com.redhat.ceylon.compiler.java.test.model::bogusTopLevelAttributeInvalidType: Expecting word but got AND")
                );
    }
    ...
    public void bogusModelAnnotationsTopLevelMethod(){
        ...
        assertErrors("bogusTopLevelMethodUser",
                ...
                new CompilerError(3, "could not determine type of function or value reference: the type of 'bogusTopLevelMethodNoMethod' is not known - Error while loading the com.redhat.ceylon.compiler.java.test.model/1 module:\n" +
                        "   Error while resolving toplevel method com.redhat.ceylon.compiler.java.test.model::bogusTopLevelMethodNoMethod: static method missing"),
                new CompilerError(4, "could not determine type of function or value reference: the type of 'bogusTopLevelMethodNotStatic' is not known - Error while loading the com.redhat.ceylon.compiler.java.test.model/1 module:\n"+
                        "   Error while resolving toplevel method com.redhat.ceylon.compiler.java.test.model::bogusTopLevelMethodNotStatic: method is not static"),
                new CompilerError(5, "could not determine type of function or value reference: the type of 'bogusTopLevelMethodMissingType' is not known - Error while loading the com.redhat.ceylon.compiler.java.test.model/1 module:\n"+
                        "   Error while resolving type of toplevel method for com.redhat.ceylon.compiler.java.test.model::bogusTopLevelMethodMissingType:\n"+
                        "   Could not find type 'com.redhat.ceylon.compiler.java.test.model.MissingType'"),
                new CompilerError(6, "could not determine type of function or value reference: the type of 'bogusTopLevelMethodInvalidType' is not known - Error while loading the com.redhat.ceylon.compiler.java.test.model/1 module:\n" + 
                        "   Error while parsing type of toplevel method for com.redhat.ceylon.compiler.java.test.model::bogusTopLevelMethodInvalidType:\n" + 
                        "   Expecting word but got AND")
