 ...
 * MA  02110-1301, USA.
 */
abstract class FormalClasses_Graph<N,E>() 
...
class FormalClasses_BasicGraph() extends FormalClasses_Graph<Node,Edge>() {
...
class FormalClasses_OnOffGraph() extends FormalClasses_Graph<Node,Edge>() {
