...
@nomodel
class ClassDefaultMemberClassWithTypeParams_sub<X>(X xx) extends ClassDefaultMemberClassWithTypeParams<X>(xx) {
    shared actual class Member<Y>(X x, Y y) extends ClassDefaultMemberClassWithTypeParams.Member<Y>(x, y) {
    }
