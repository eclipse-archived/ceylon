...
public class CMRTestHTTP extends CompilerTest {
    ...
    private void testMdlHTTPOutputRepo(boolean herd, int requests) throws IOException{
        ...
        ZipEntry moduleClass = car.getEntry("com/redhat/ceylon/compiler/java/test/cmr/module/single/module_.class");
    ...
    private void testMdlHTTPMixedCompilation(boolean herd, int requests) throws IOException{
        ...
        // make sure it's not empty
        ZipEntry entry = car.getEntry("com/redhat/ceylon/compiler/java/test/cmr/module/mixed/module_.class");
        assertNotNull(entry);
