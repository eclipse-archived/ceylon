...
public class AnnotationsTests extends CompilerTests {
    ...
    public void test5751(){
        ...
        assertErrors("5751", true,
                ...
                CompilerError.warning(14, "the 'late' attribute 's4' cannot be properly initialised just by setting the field value because it has an optional type: depending on the semantics of 'fieldTarget' consider making it non-'late'"),
                CompilerError.warning(17, "the 'late' attribute 's5' cannot be properly initialised just by setting the field value because it has an optional type: depending on the semantics of 'fieldTarget' consider making it non-'late'"),
                CompilerError.warning(21, "the 'late' attribute 's6' cannot be properly initialised just by setting the field value because it has an optional type: depending on the semantics of 'fieldTarget' consider making it non-'late'"),
                CompilerError.warning(26, "the 'late' attribute 's7' cannot be properly initialised just by setting the field value because it has an optional type: depending on the semantics of 'fieldOrMethodTarget' consider annotating the JavaBean Property getter with fieldOrMethodTarget__GETTER or its setter with fieldOrMethodTarget__SETTER or making it non-'late'"),
                CompilerError.warning(28, "the 'late' attribute 's8' cannot be properly initialised just by setting the field value because it is erased to a primitive type: depending on the semantics of 'fieldOrMethodTarget' consider annotating the JavaBean Property getter with fieldOrMethodTarget__GETTER or its setter with fieldOrMethodTarget__SETTER or making it non-'late'")
                );
    }
