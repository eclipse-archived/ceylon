...
public class CeylonCompileScriptTests extends AntBasedTests {

    public CeylonCompileScriptTests() throws Exception {
        super("test/src/org/eclipse/ceylon/itest/ceylon-compile-script.xml");
    }
