...
import static org.eclipse.ceylon.compiler.java.codegen.Naming.DeclNameFlag.COMPANION;
...
import org.eclipse.ceylon.compiler.java.codegen.CodegenUtil;
...
public class NamingTests {
    ...
    public NamingTests () {
        super();
        org.eclipse.ceylon.langtools.tools.javac.util.Context context = new org.eclipse.ceylon.langtools.tools.javac.util.Context();
    ...
    public void testC() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.C", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testCC() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.CC.C", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testCI() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.CI$I", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testCo() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.Co.o_.get_", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testI() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.I", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testIC() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.IC$impl.C", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testII() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.II$I", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testIo() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.Io$impl.o_.get_", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testo() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.o_.get_", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testoC() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.oC_.C", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testoI() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.oI$I_", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testoo() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.oo_.o_.get_", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    
    @Test
    public void testf() throws Exception {
        final Declaration decl = findDecl("f.ceylon", "f");
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.f_.f", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    ...
    public void testv() throws Exception {
        ...
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.v_.get_", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    
    @Test
    public void testg() throws Exception {
        final Declaration decl = findDecl("g.ceylon", "g");
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.g_.get_", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    
    @Test
    public void testCm() throws Exception {
        final Declaration decl = findDecl("Cm.ceylon", "Cm.m");
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.Cm.m", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
    
    @Test
    public void testCa() throws Exception {
        final Declaration decl = findDecl("Ca.ceylon", "Ca.a");
        assertEquals("org.eclipse.ceylon.compiler.java.codegen.Ca.getA", CodegenUtil.getJavaNameOfDeclaration(decl));
    }
