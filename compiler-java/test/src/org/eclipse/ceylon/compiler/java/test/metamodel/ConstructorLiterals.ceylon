...
void defaultCtorDeclAssertions(CallableConstructorDeclaration decl) {
    assert("new org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals" == decl.string);
...
void memberDefaultCtorDeclAsserions(CallableConstructorDeclaration decl) {
    assert("new org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals.Member" == decl.string);
...
void valueCtorDeclAssertions(ValueConstructorDeclaration decl) {
    assert("new org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiteralsSub.val" == decl.string);
...
void memberValueCtorDeclAssertions(ValueConstructorDeclaration decl) {
    assert("new org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiteralsSub.Member2.val2" == decl.string);
...
void callableCtorDeclAssertions(CallableConstructorDeclaration decl) {
    assert("new org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals.other" == decl.string);
    assert(!decl.abstract);
    assert(`class ConstructorLiterals` == decl.container);
    ...
    assert("value org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals.other.t" == pd.string);
    assert(pd.parameter);
...
void memberCallableCtorDeclAssertions(CallableConstructorDeclaration decl) {
    assert("new org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals.Member.other" == decl.string);
}

void valueCtorModelAssertions(ValueConstructor<ConstructorLiteralsSub> model) {
    assert("org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiteralsSub.val" == model.string);
...
void memberValueCtorModelAssertions(MemberClassValueConstructor<ConstructorLiteralsSub, ConstructorLiteralsSub.Member2> model) {
    assert("org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiteralsSub.Member2.val2" == model.string);
}
void callableCtorModelAssertions(CallableConstructor<ConstructorLiterals<String>,[String]> model) {
    assert("org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals<ceylon.language::String>.other" == model.string);
...
void memberCallableCtorModelAssertions(MemberClassCallableConstructor<ConstructorLiterals<String>, ConstructorLiterals<String>.Member, [String]> model) {
    assert("org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals<ceylon.language::String>.Member.other" == model.string);
}

void defaultCtorModelAssertions(Class<ConstructorLiterals<String>,[String]> defaultCtorModel) {
    assert("org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals<ceylon.language::String>" == defaultCtorModel.string);
...
void memberDefaultCtorModelAssertions(MemberClass<ConstructorLiterals<String>, ConstructorLiterals<String>.Member, [String]> defaultMemberCtorModel) {
    assert("org.eclipse.ceylon.compiler.java.test.metamodel::ConstructorLiterals<ceylon.language::String>.Member" == defaultMemberCtorModel.string);
}
