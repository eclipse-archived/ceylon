...
public class StructureTests extends CompilerTests {
    ...
    @Test
    public void testAtrCallableParameter() {
        compareWithJavaSource("attribute/CallableParameter");
    }
    @Test
    ...
    public void testKlsRefinedVarianceInheritance(){
        ...
        compileAndRun("org.eclipse.ceylon.compiler.java.test.structure.klass.rvi_run", "klass/RefinedVarianceInheritance.ceylon");
    }
    @Test
    ...
    public void testKlsInlineObject(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.structure.klass.testInlineObjects");
    }
    @Test
    ...
    public void testRfdRuntime(){
        compileAndRun("org.eclipse.ceylon.compiler.java.test.structure.reified.runtime", "reified/Runtime.ceylon");
    }
