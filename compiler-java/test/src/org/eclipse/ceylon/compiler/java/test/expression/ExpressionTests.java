 ...
 * MA  02110-1301, USA.
 */
package org.eclipse.ceylon.compiler.java.test.expression;
...
public class ExpressionTests extends CompilerTests {
    ...
    public void testAvoidBackwardBranchWithNew(){
        compileAndRun(
                "org.eclipse.ceylon.compiler.java.test.expression.instantiation.avoidBackwardBranchWithNew_run", 
                "instantiation/AvoidBackwardBranchWithNew.ceylon");
    }
    @Test
    public void testAvoidBackwardBranchWithSuper(){
        compileAndRun(
                "org.eclipse.ceylon.compiler.java.test.expression.instantiation.avoidBackwardBranchWithSuper_run", 
    ...
    public void testOprSequenceOperators(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.operator.sequenceOperators");
    }
    @Test
    ...
    public void testOprIntPowerWithIntLiteralOptimCorrect(){
        compileAndRun("org.eclipse.ceylon.compiler.java.test.expression.operator.intPowerWithIntLiteralOptimCorrect", 
    ...
    public void testOprFloatPowerWithIntLiteralOptimCorrect(){
        compileAndRun("org.eclipse.ceylon.compiler.java.test.expression.operator.floatPowerWithIntLiteralOptimCorrect", 
    ...
    @Test
    public void testOprSpreadOptimization(){
        compareWithJavaSource("operator/SpreadOptimization");
        run("org.eclipse.ceylon.compiler.java.test.expression.operator.spreadOptimization");
    }
    @Test
    ...
    public void testOptmInIntegerSpanCorrect(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.optimisations.inIntegerSpanCorrect");
    }
    ...
    public void testOptmInCharacterSpanCorrect(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.optimisations.inCharacterSpanCorrect");
    }
    ...
    public void testOptmInIntegerMeasureCorrect(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.optimisations.inIntegerMeasureCorrect");
    }
    ...
    public void testOptmInCharacterMeasureCorrect(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.optimisations.inCharacterMeasureCorrect");
    }
}
