...
public class IssuesTests_0500_0999 extends CompilerTests {
    ...
    public void testBug660(){
        ...
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug06xx.bug660", "bug06xx/Bug660.ceylon");
    }
    ...
    public void testBug669() {
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug06xx.bug669_testAssertEquals", "bug06xx/Bug669.ceylon");
    }
    
    @Test
    public void testBug671(){
        compareWithJavaSource("bug06xx/Bug671");
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug06xx.bug671", "bug06xx/Bug671.ceylon");
    }
    ...
    public void testBug706() {
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug07xx.bug706", "bug07xx/Bug706.ceylon");
    }
    ...
    public void testBug751() {
        assertErrors("bug07xx/Bug751", new CompilerError(20, "package not found in imported modules: 'laknsd.askduyasjd' (add module import to module descriptor of 'org.eclipse.ceylon.compiler.java.test.issues')"));
    }
    ...
    public void testBug817() {
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug08xx.bug817.bug817", "bug08xx/bug817/NullArray.java", "bug08xx/bug817/Bug817.ceylon");
    }
    ...
    public void testBug871() {
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug08xx.bug871", "bug08xx/Bug871.ceylon");
    }
    ...
    public void testBug949() {
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug09xx.bug949", "bug09xx/Bug949.ceylon");
    }

    @Test
    public void testBug950() {
        assertErrors("bug09xx/Bug950",
                new CompilerError(34, "type 'Bug950_Bottom' inherits but does not refine multiple definitions of 'foo': inherited member 'foo' is defined by supertypes 'Bug950_Left' and 'Bug950_Right' (refine 'foo' in 'Bug950_Bottom')"));
    ...
    public void testBug974() {
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug09xx.Bug974", "bug09xx/Bug974.ceylon");
    }
    ...
    public void testBug976() {
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug09xx.bug976", "bug09xx/Bug976.ceylon");
    }
    ...
    public void testBug986() {
        compileAndRun("org.eclipse.ceylon.compiler.java.test.issues.bug09xx.bug986", "bug09xx/Bug986.ceylon");
    }
    ...
    public void testBug996() {
        ...
        run("org.eclipse.ceylon.compiler.java.test.issues.bug09xx.bug996");
    }
