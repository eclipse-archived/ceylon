...
import org.eclipse.ceylon.compiler.java.codegen.CeylonTransformer;
import org.eclipse.ceylon.compiler.java.codegen.ClassTransformer;
import org.eclipse.ceylon.compiler.java.codegen.Decl;
import org.eclipse.ceylon.compiler.java.codegen.ExpressionTransformer;
import org.eclipse.ceylon.compiler.java.codegen.StatementTransformer;
...
import org.eclipse.ceylon.langtools.tools.javac.api.JavacTaskImpl;
...
import org.eclipse.ceylon.model.loader.impl.reflect.mirror.ReflectionUtils;
...
public class ModelLoaderTests extends CompilerTests {
    ...
    protected String packageForJavaModelLoading() {
        return "org.eclipse.ceylon.compiler.java.test.model";
    }
    ...
    public void ceylonDeprecated(){
        ...
        ArrayList<CompilerError> expected = new ArrayList<CompilerError>(Arrays.asList(
                CompilerError.warning(3, "type is deprecated: 'CeylonDeprecated' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(4, "declaration is deprecated: 'CeylonDeprecated' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(6, "type is deprecated: 'CeylonDeprecated2' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(7, "declaration is deprecated: 'CeylonDeprecated2' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(10, "declaration is deprecated: default constructor of 'CeylonDeprecated3' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(11, "declaration is deprecated: 'other' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(11, "declaration is deprecated: default constructor of 'CeylonDeprecated3' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(12, "declaration is deprecated: 'val' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(14, "declaration is deprecated: 'a' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(15, "declaration is deprecated: 'm' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(17, "declaration is deprecated: 'a' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(18, "declaration is deprecated: 'm' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(20, "type is deprecated: 'CeylonDeprecated6' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(22, "declaration is deprecated: 'ceylonDeprecated7' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(23, "declaration is deprecated: 'ceylonDeprecated8' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
                CompilerError.warning(25, "declaration is deprecated: 'ceylonDeprecated9' is annotated 'deprecated' in 'org.eclipse.ceylon.compiler.java.test.model' '\"1\"'"),
    ...
    public void bogusModelAnnotationsTopLevelAttribute(){
        ...
        assertErrors("bogusTopLevelAttributeUser",
                new CompilerError(2, "Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n"
                        +"   Error while resolving toplevel attribute org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelAttributeNoGetter: getter method missing"),
                new CompilerError(-1, "Error while resolving type of toplevel attribute for org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelAttributeMissingType: Could not find type 'org.eclipse.ceylon.compiler.java.test.model.MissingType'"),
                new CompilerError(-1, "Error while parsing type of toplevel attribute for org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelAttributeInvalidType: Expecting word but got AND"),
                new CompilerError(3, "could not determine type of function or value reference: the type of 'bogusTopLevelAttributeNoGetter' is not known - Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n"+
                        "   Error while resolving toplevel attribute org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelAttributeNoGetter: getter method missing"),
                new CompilerError(4, "could not determine type of function or value reference: the type of 'bogusTopLevelAttributeMissingType' is not known - Error while resolving type of toplevel attribute for org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelAttributeMissingType: Could not find type 'org.eclipse.ceylon.compiler.java.test.model.MissingType'"),
                new CompilerError(5, "could not determine type of function or value reference: the type of 'bogusTopLevelAttributeInvalidType' is not known - Error while parsing type of toplevel attribute for org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelAttributeInvalidType: Expecting word but got AND")
                );
    }
    ...
    public void bogusModelAnnotationsTopLevelMethod(){
        ...
        assertErrors("bogusTopLevelMethodUser",
                new CompilerError(2, "Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n"
                        +"   Error while resolving toplevel method org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelMethodNoMethod: static method missing"),
                new CompilerError(2, "Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n"
                        +"   Error while resolving toplevel method org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelMethodNotStatic: method is not static"),
                new CompilerError(2, "Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n"
                        ...
                        +"   Could not find type 'org.eclipse.ceylon.compiler.java.test.model.MissingType'"),
                new CompilerError(2, "Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n"
                ...
                new CompilerError(3, "could not determine type of function or value reference: the type of 'bogusTopLevelMethodNoMethod' is not known - Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n" +
                        "   Error while resolving toplevel method org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelMethodNoMethod: static method missing"),
                new CompilerError(4, "could not determine type of function or value reference: the type of 'bogusTopLevelMethodNotStatic' is not known - Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n"+
                        "   Error while resolving toplevel method org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelMethodNotStatic: method is not static"),
                new CompilerError(5, "could not determine type of function or value reference: the type of 'bogusTopLevelMethodMissingType' is not known - Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n"+
                        "   Error while resolving type of toplevel method for org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelMethodMissingType:\n"+
                        "   Could not find type 'org.eclipse.ceylon.compiler.java.test.model.MissingType'"),
                new CompilerError(6, "could not determine type of function or value reference: the type of 'bogusTopLevelMethodInvalidType' is not known - Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n" + 
                        "   Error while parsing type of toplevel method for org.eclipse.ceylon.compiler.java.test.model::bogusTopLevelMethodInvalidType:\n" + 
                        "   Expecting word but got AND")
    ...
    public void bogusModelAnnotationsTopLevelClass(){
        ...
        assertErrors("bogusTopLevelClassUser",
                new CompilerError(-1, "Constructor for 'org.eclipse.ceylon.compiler.java.test.model.BogusTopLevelClass' should take 1 reified type arguments (TypeDescriptor) but has '0': skipping constructor."),
                new CompilerError(-1, "Invalid type signature for self type of org.eclipse.ceylon.compiler.java.test.model::BogusTopLevelClass: org.eclipse.ceylon.compiler.java.test.model::MissingType is not a type parameter"),
                new CompilerError(2, "Error while loading the org.eclipse.ceylon.compiler.java.test.model/1 module:\n   Error while resolving type of extended type for org.eclipse.ceylon.compiler.java.test.model::BogusTopLevelClass:\n   Could not find type 'org.eclipse.ceylon.compiler.java.test.model.MissingType'"),
                new CompilerError(3, "class cannot be instantiated: 'BogusTopLevelClass' does not have a default constructor")
        );
    }
