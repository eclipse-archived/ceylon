 ...
 * MA  02110-1301, USA.
 */
package org.eclipse.ceylon.compiler.java.test.bc;
...
public class BcTests extends CompilerTests {
    ...
    private final String clientModuleName = "org.eclipse.ceylon.compiler.java.test.bc.client";
    private final String providerModuleName = "org.eclipse.ceylon.compiler.java.test.bc.provider";
    ...
    public void testBinaryVersionIncompatibleModule1() throws IOException {
        ...
        assertErrors("binaryVersion/module", new CompilerError(21, 
                "version '1' of module 'org.eclipse.ceylon.compiler.java.test.bc.binaryVersionOld' was compiled by"
    ...
    public void testBinaryVersionIncompatibleModule2() throws IOException {
        ...
        assertErrors("binaryVersion2/module", new CompilerError(21, 
                "version '1' of module 'org.eclipse.ceylon.compiler.java.test.bc.binaryVersionOld2' was compiled by"
                + " an incompatible version of the compiler"
                +" (binary version 0.0 of module is not compatible with binary version "
                +Versions.JVM_BINARY_MAJOR_VERSION+"."+Versions.JVM_BINARY_MINOR_VERSION+" of this compiler)"));
    }
    ...
    public void bug6068() {
        ...
        run("org.eclipse.ceylon.compiler.java.test.bc.refinedreturn.bug6068", 
                new ModuleWithArtifact("org.eclipse.ceylon.compiler.java.test.bc.refinedreturn", "1"),
