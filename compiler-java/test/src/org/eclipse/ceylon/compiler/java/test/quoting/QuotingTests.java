 ...
 * MA  02110-1301, USA.
 */
package org.eclipse.ceylon.compiler.java.test.quoting;
...
public class QuotingTests extends CompilerTests {
    ...
    public void testCaseCollision(){
        try {
            compileAndRun("org.eclipse.ceylon.compiler.java.test.quoting.$goto.CaseCollision", "goto/CaseCollision.ceylon");
            Assert.fail();
