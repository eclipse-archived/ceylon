...
void literalsRuntime2<T>(){
    ...
    assert(`new LitClassWithConstructors`.qualifiedName == "org.eclipse.ceylon.compiler.java.test.metamodel::LitClassWithConstructors");
    print(`new LitClassWithConstructors`.string == "new org.eclipse.ceylon.compiler.java.test.metamodel::LitClassWithConstructors");
