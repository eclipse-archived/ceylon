...
public class StaticRefTests extends CompilerTests {
    ...
    public void testRefAttributeRef() {
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.attributeRef");
    }
    ...
    public void testRefValueParameterRef() {
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.valueParameterRef");
    }
    ...
    public void testRefMethodRef() {
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.methodRef");
    }
    ...
    public void testRefFunctionalParameterRef() {
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.functionalParameterRef");
    }
    ...
    public void testRefMemberClassRef() {
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.memberClassRef");
    }
    ...
    public void testRefMemberClassRefInFunction() {
        ...
        //compile("MemberClassRef.ceylon");
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.memberClassRefInFunction");
    }
    
    @Test
    public void testRefFunrefs() {
        compareWithJavaSource("funrefs");
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.funrefs");
    ...
    public void testRefConstructorRef() {
        ...
        //compile("MemberClassRef.ceylon");
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.constructorRef");
    }
    ...
    public void testRefMemberClassConstructorRef() {
        ...
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.memberClassConstructorRef");
    }
    
    @Test
    public void testRefBug5898() {
        compareWithJavaSource("Bug5898");
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.bug5898");
    }
    
    @Test
    public void testRefBug5899() {
        compareWithJavaSource("Bug5899");
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.bug5899");
    }
    
    @Test
    public void testRefBug5965() {
        compareWithJavaSource("Bug5965");
        run("org.eclipse.ceylon.compiler.java.test.expression.ref.bug5965");
    }
