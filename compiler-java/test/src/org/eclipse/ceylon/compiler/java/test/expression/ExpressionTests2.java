...
public class ExpressionTests2 extends CompilerTests {
    ...
    public void testInvObjectArgumentNamedInvocationChained(){
        ...
        compileAndRun("org.eclipse.ceylon.compiler.java.test.expression.invoke.objectArgumentNamedInvocationChained", "invoke/ObjectArgumentNamedInvocationChained.ceylon");
    }
    ...
    public void testCallableArgumentWithDefaultedArguments(){
        ...
        compileAndRun("org.eclipse.ceylon.compiler.java.test.expression.invoke.callableArgumentWithDefaulted_main", 
    ...
    public void testAvoidBackwardBranchWithVarargs(){
        compileAndRun(
                "org.eclipse.ceylon.compiler.java.test.expression.invoke.avoidBackwardBranchWithVarargs_run", 
    ...
    @Test
    public void testLetVoidExpression(){
        compareWithJavaSource("let/LetVoid");
    }
