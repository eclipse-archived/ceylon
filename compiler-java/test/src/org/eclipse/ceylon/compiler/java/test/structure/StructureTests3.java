...
public class StructureTests3 extends CompilerTests {
    ...
    public void testTypefnTypeFn1(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.structure.typefn.genericFunctionReference");
        run("org.eclipse.ceylon.compiler.java.test.structure.typefn.genericLocalFunctionReference");
        run("org.eclipse.ceylon.compiler.java.test.structure.typefn.genericClassReference");
    }
