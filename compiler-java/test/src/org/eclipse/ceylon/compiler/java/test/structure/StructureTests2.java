...
public class StructureTests2 extends CompilerTests {
    ...
    public void testTopToplevelAttributeLate2(){
        compileAndRun("org.eclipse.ceylon.compiler.java.test.structure.toplevel.toplevelAttributeLate2", "toplevel/ToplevelAttributeLate2.ceylon");
    }
    @Test
    ...
    @Test
    public void testTopToplevelObjectWithValueMember(){
        compareWithJavaSource("toplevel/ToplevelObjectWithValueMember");
    }
    @Test
    ...
    public void testCncString(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.structure.concrete.concreteString");
    }
    ...
    public void testCncBug2316(){
        ...
        run("org.eclipse.ceylon.compiler.java.test.structure.concrete.bug2316");
    }
}
