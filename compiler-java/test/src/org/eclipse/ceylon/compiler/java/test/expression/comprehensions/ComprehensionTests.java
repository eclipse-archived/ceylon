...
public class ComprehensionTests extends CompilerTests {
    ...
    protected ModuleWithArtifact getDestModuleWithArtifact(String main){
        return new ModuleWithArtifact("org.eclipse.ceylon.compiler.java.test.expression.comprehensions", "1.0");
    }
    ...
    public void testOptimizedTupleEnumWithComprehension() throws ReflectiveOperationException {
        ...
        Object seq = run("org.eclipse.ceylon.compiler.java.test.expression.comprehensions.optimizedTupleEnumWithComprehensionOverTuple");
        assertArraySequenceWithArraySize(seq, 10);
        seq = run("org.eclipse.ceylon.compiler.java.test.expression.comprehensions.optimizedTupleEnumWithComprehensionOverArraySequence");
        assertArraySequenceWithArraySize(seq, 10);
        seq = run("org.eclipse.ceylon.compiler.java.test.expression.comprehensions.optimizedTupleEnumWithComprehensionOverRange");
        assertArraySequenceWithArraySize(seq, 10);
        seq = run("org.eclipse.ceylon.compiler.java.test.expression.comprehensions.optimizedTupleEnumWithComprehensionOverString");
        assertArraySequenceWithArraySize(seq, 10);
        seq = run("org.eclipse.ceylon.compiler.java.test.expression.comprehensions.optimizedTupleEnumWithComprehensionOverArray");
        assertArraySequenceWithArraySize(seq, 10);
    }
