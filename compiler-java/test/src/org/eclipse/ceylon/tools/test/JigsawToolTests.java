...
public class JigsawToolTests extends AbstractToolTests {
    ...
    public void testCopy() throws Exception {
        ...
        Assert.assertTrue(new File(out, "org.eclipse.ceylon.model-"+Versions.CEYLON_VERSION_NUMBER+".jar").exists());
        Assert.assertTrue(new File(out, "org.eclipse.ceylon.module-resolver-"+Versions.CEYLON_VERSION_NUMBER+".jar").exists());
    }

    @Test
    public void testCopyExcludes() throws Exception {
        File out = new File(getOutPath());
        Assert.assertFalse(new File(out, "org.eclipse.ceylon.maven-support-"+Versions.DEPENDENCY_MAVEN_SUPPORT_VERSION+".jar").exists());
        ...
        CeylonJigsawTool tool = pluginFactory.bindArguments(model, getMainTool(), 
                Arrays.asList(
                        ...
                        "--rep", getOutPath(),
                        "--out", getOutPath(),
                        "--exclude-module", "org.eclipse.ceylon.maven-support",
                        "ceylon.language/"+Versions.CEYLON_VERSION_NUMBER));
        tool.run();
