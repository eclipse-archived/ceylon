...
import org.eclipse.ceylon.common.tool.NonFatalToolMessage;
...
import org.eclipse.ceylon.compiler.CompilerErrorException;
import org.eclipse.ceylon.compiler.SystemErrorException;
...
public class CompilerToolTests extends AbstractToolTests {
    ...
    public void testCompile()  throws Exception {
        ...
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.ceylon"));
        tool.run();
    }
    ...
    public void testCompileKeywordsInModuleName()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.keywords.long.module"));
        tool.run();
    }
    ...
    public void testCompileVerbose()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--verbose", "--src=test/src", "org.eclipse.ceylon.tools.test.ceylon"));
        tool.run();
    }
    ...
    public void testCompileDefault()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src/org/eclipse/ceylon/tools/test/deflt", "default"));
        tool.run();
    }
    ...
    public void testCompileMultiple()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.multiple.*"));
        tool.run();
    ...
    public void testCompileMultipleAutodetect()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src/org/eclipse/ceylon/tools/test/bugCC59"));
        tool.run();
    ...
    public void testCompileNoSuchModule()  throws Exception {
        ...
        try {
            CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                    toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.nosuchmodule"));
            Assert.fail();
    ...
    public void testCompileNoSuchModuleDotJava()  throws Exception {
        ...
        try {
            CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                    toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.nosuchmodule.java"));
            Assert.fail();
        } catch (OptionArgumentException e) {
    ...
    public void testCompileNoSuchModuleDotCeylon()  throws Exception {
        ...
        try {
            CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                    toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.nosuchmodule.ceylon"));
            Assert.fail();
        } catch (OptionArgumentException e) {
    ...
    public void testCompileValidEncoding()  throws Exception {
        ...
        Assert.assertNotNull(model);        
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "--encoding=UTF-8", "org.eclipse.ceylon.tools.test.ceylon"));
    }
    ...
    public void testCompileNoSuchEncoding()  throws Exception {
        ...
        try {
            CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                    toolOptions("--src=test/src", "--encoding=foo", "org.eclipse.ceylon.tools.test.ceylon"));
            Assert.fail();
        } catch (OptionArgumentException e) {
    ...
    public void testCompileModuleAndVersion()  throws Exception {
        ...
        try {
            CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                    toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.ceylon/1.0"));
            Assert.fail();
        } catch (OptionArgumentException e) {
    ...
    public void testCompileWithSyntaxErrors()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.syntax"));
        try{
            tool.run();
    ...
    public void testCompileWithAnalysisErrors()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.analysis"));
        try{
            tool.run();
            Assert.fail("Tool should have thrown an exception");
        }catch(CompilerErrorException x){
    ...
    public void testCompileWithErroneous()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.erroneous"));
        try{
            tool.run();
            Assert.fail("Tool should have thrown an exception");
        }catch(CompilerErrorException x){
    ...
    public void testCompileWithRuntimeException()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.runtimeex"));
        try{
            tool.run();
            Assert.fail("Tool should have thrown an exception");
        }catch(CompilerErrorException x){
    ...
    public void testCompileWithOomeException()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.oome"));
        try{
            tool.run();
            Assert.fail("Tool should have thrown an exception");
    ...
    public void testCompileWithStackOverflowError()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.stackoverflow"));
        try{
            tool.run();
            Assert.fail("Tool should have thrown an exception");
        }catch(SystemErrorException x){
    ...
    public void testBug1183()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.bug1183"));
        try {
            tool.run();
            Assert.fail("Tool should have thrown an exception");
    ...
    public void testBadIntegerLiteral()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "org.eclipse.ceylon.tools.test.badintegerliteral"));
        try {
            tool.run();
            Assert.fail("Tool should have thrown an exception");
        } catch (CompilerErrorException e) {
    ...
    public void testBug1623()  throws Exception {
        ...
        try {
            CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                    toolOptions("--src=test/src/org/eclipse/ceylon/tools/test/empty"));
            Assert.fail("Tool should have thrown an exception");
    ...
    public void testDefaultModuleNoFiles()  throws Exception {
        ...
        try {
            CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                    toolOptions("--src=test/src/org/eclipse/ceylon/tools/test/empty", "default"));
            tool.run();
            Assert.fail("Tool should have thrown an exception");
    ...
    public void testTarget()  throws Exception {
        ...
        Assert.assertNotNull(model);
        CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                toolOptions("--src=test/src", "--target=8", "org.eclipse.ceylon.tools.test.java8"));
        tool.run();
    ...
    public void testTargetInvalid()  throws Exception {
        ...
        try {
            CeylonCompileTool tool = pluginFactory.bindArguments(model, getMainTool(),
                    toolOptions("--src=test/src", "--target=56", "org.eclipse.ceylon.tools.test.java8"));
