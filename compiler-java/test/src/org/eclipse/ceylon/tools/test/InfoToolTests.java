...
import org.eclipse.ceylon.tools.info.CeylonInfoTool;
...
public class InfoToolTests extends AbstractToolTests {
    ...
    public void testModuleFromSource() throws Exception {
        ...
        CeylonInfoTool tool = pluginFactory.bindArguments(model, getMainTool(), 
                Arrays.<String>asList("--src", "test/src", "org.eclipse.ceylon.tools.test.info/1"));
        ...
        Assert.assertTrue(b.toString()
                ...
                .contains(
                "Name:        org.eclipse.ceylon.tools.test.info\n"+
                "Version:     1\n"+
