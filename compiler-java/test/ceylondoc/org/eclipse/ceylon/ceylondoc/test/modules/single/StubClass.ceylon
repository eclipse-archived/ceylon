...
import org.eclipse.ceylon.ceylondoc.test.modules.single.a { A1, AliasA2 = A2 }
 ...
 */
"This is `StubClass`"
see(`class`, `interface StubInterface`, `value stubTopLevelAttribute`, `function stubTopLevelMethod`, `module org.eclipse.ceylon.ceylondoc.test.modules.single`, `package org.eclipse.ceylon.ceylondoc.test.modules.single.a`)
...
shared class StubClass(
  ...
  shared void printHello(String name) => print("Hello ``name``")) 
    ...
    "Wiki-style links:
     ...
     1. unresolvable3 = [[org.eclipse.ceylon.ceylondoc.test.modules.single::]]
     1. imported A1 = [[A1]]
     ...
     1. module = [[module org.eclipse.ceylon.ceylondoc.test.modules.single]]
     1. package = [[package org.eclipse.ceylon.ceylondoc.test.modules.single]]
     1. PrivateClass = [[PrivateClass]]
     
     Wiki-style links with full qualified name:
     
     1. fullStubInterface = [[org.eclipse.ceylon.ceylondoc.test.modules.single::StubInterface]]
     1. fullStubInterface.formalMethodFromStubInterface = [[org.eclipse.ceylon.ceylondoc.test.modules.single::StubInterface.formalMethodFromStubInterface]]
     1. fullStubInterface with custom name = [[full custom stub interface|org.eclipse.ceylon.ceylondoc.test.modules.single::StubInterface]]
