...
public class CeylonCompilerLauncher
{
...
final PrintStream out;
  ...
  CeylonCompilerLauncher(FileInputStream is, PrintStream out)
  {
    this.out = out;
    this.is = is;
  }
    ...
    throws Exception
  {
    ...
    for (String filename: args) {
      ...
      CeylonCompilerLauncher theCeylonCompiler;
      ...
      if (outputdir != "")
        {
          ...
          theCeylonCompiler
            = new CeylonCompilerLauncher (new FileInputStream(filename),
        ...
        {
          theCeylonCompiler
            = new CeylonCompilerLauncher (new FileInputStream(filename), System.out);
        }
