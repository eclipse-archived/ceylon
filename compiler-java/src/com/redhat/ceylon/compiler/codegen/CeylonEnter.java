...
public class CeylonEnter extends Enter {
    ...
    private void typeCheck() {
        ...
        /*for (PhasedUnit pu : listOfUnits) { pu.scanTypeDeclarations(); } for
         * (PhasedUnit pu: listOfUnits) { pu.validateRefinement(); } for
         * (PhasedUnit pu : listOfUnits) { pu.analyseTypes(); } for (PhasedUnit
         * pu : listOfUnits) { pu.display(); pu.runAssertions(); } */
    }
}
