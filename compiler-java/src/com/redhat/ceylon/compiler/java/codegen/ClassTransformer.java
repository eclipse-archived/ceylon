...
public class ClassTransformer extends AbstractTransformer {
    ...
    private void addRefinedThrowerAttribute(
        ...
        AttributeDefinitionBuilder getterBuilder = AttributeDefinitionBuilder.getter(this, refined.getName(), refined, AttrTx.THIS);
        ...
        if (formalAttribute.isVariable()) {
            AttributeDefinitionBuilder setterBuilder = AttributeDefinitionBuilder.setter(this, node, refined.getName(), refined, AttrTx.THIS);
    ...
    private void makeAttributeForValueParameter(ClassDefinitionBuilder classBuilder, 
        ...
        if (decl.getDeclaration() instanceof Constructor) {
            ...
            AttributeDefinitionBuilder adb = AttributeDefinitionBuilder.getter(this, decl.getName(), decl.getModel(), AttrTx.THIS);
            ...
            if (value.isVariable()) {
                AttributeDefinitionBuilder setter = AttributeDefinitionBuilder.setter(this, parameterTree, decl.getName(), decl.getModel(), AttrTx.THIS);
            ...
            if (Strategy.hasDefaultParameterValueMethod(paramModel)
                ...
                if (!delegationConstructor) {
                    if ((Strategy.hasDefaultParameterValueMethod(paramModel) 
                        ...
                        if (!generateInstantiator || Decl.equal(refinedParam, paramModel)) {
                            ...
                            cbForDevaultValues.method(makeParamDefaultValueMethod(DaoKind.THIS, constructor != null ? constructor : cls, paramList, param));
                            if (cbForDevaultValuesDecls != null) {
                                cbForDevaultValuesDecls.method(makeParamDefaultValueMethod(DaoKind.ABSTRACT, constructor != null ? constructor : cls, paramList, param));
                            }
                ...
                if (generateInstantiator) {
                    if (Decl.withinInterface(cls)) {
                        ...
                        MethodDefinitionBuilder instBuilder = new DefaultedArgumentInstantiator(DaoKind.ABSTRACT, cls, constructor,
                    ...
                    if (!Decl.withinInterface(cls) || !cls.isFormal()) {
                        MethodDefinitionBuilder instBuilder = new DefaultedArgumentInstantiator(DaoKind.THIS, cls, constructor,
                ...
                if (addOverloadedConstructor) {
                    ...
                    if (constructor != null) {
                        dac = new DefaultedArgumentConstructor(constructor, paramList, delegationConstructor);
                    } else {
                        dac = new DefaultedArgumentConstructor(cls, paramList, delegationConstructor);
                    }
                    dac.makeOverload(
    ...
    private void makeMethodForFunctionalParameter(
        ...
        if (Strategy.createMethod(paramModel)) {
            ...
            classBuilder.methods(transformMethod(method, methodDecl,
                    ...
                    List.of(body), DaoKind.THIS).toList());
        }
    }
        ...
        if (member instanceof Class) {
            ...
            for (Parameter param : parameters) {
                ...
                if (Strategy.hasDefaultParameterOverload(param)) {
                    MethodDefinitionBuilder overload = new DefaultedArgumentMethodTyped(DaoKind.ABSTRACT, null, typedMember, true)
                    .makeOverload(
...
//                    final TypedReference refinedTypedMember = model.getType().getTypedMember(subMethod, Collections.<Type>emptyList());
                        ...
                        for (Parameter param : parameters) {
                            ...
                            if (Strategy.hasDefaultParameterOverload(param)) {
                                if ((method.isDefault() || method.isShared() && !method.isFormal())
                                    ...
                                    MethodDefinitionBuilder overload = new DefaultedArgumentMethodTyped(DaoKind.THIS, null, typedMember, true)
                                        .makeOverload(
    ...
    public void transform(AttributeDeclaration decl, ClassDefinitionBuilder classBuilder) {
        ...
        if (useField || withinInterface || lazy) {
            if (!withinInterface || model.isShared() && !useDefaultMethod(model)) {
                // Generate getter in main class or interface (when shared)
                at(decl.getType());
                AttributeDefinitionBuilder getter = makeGetter(decl, AttrTx.THIS, lazy);
                if (err != null) {
                ...
                if (withinInterface) {
                    if (!useDefaultMethod(model) && lazy) {
                        ...
                        if (true/*model.isFormal() || !model.isShared()*/) {
                            ...
                            classBuilder.attribute(makeSetter(decl, AttrTx.STATIC, lazy));
                        }
                    }
                }
            }
	...
	public AttributeDefinitionBuilder transform(AttributeSetterDefinition decl, AttrTx attrTx) {
        ...
        final AttributeDefinitionBuilder builder = AttributeDefinitionBuilder
                 ...
                 */
            .setter(this, decl, name, decl.getDeclarationModel().getGetter(), attrTx)
        ...
        if (attrTx == AttrTx.BRIDGE_TO_STATIC) {
            JCStatement bridgeStmt = make().Exec(make().Apply(null, 
                    naming.makeUnquotedIdent(Naming.getSetterName(decl.getDeclarationModel())), 
                    List.<JCExpression>of(naming.makeThis(), makeQuotedIdent(decl.getDeclarationModel().getName()))));
            builder.setterBlock(make().Block(0, List.<JCStatement>of(bridgeStmt)));
        } else  if (Decl.withinClass(decl) || attrTx == AttrTx.COMPANION || useDefaultMethod(decl.getDeclarationModel())) {
    ...
    public AttributeDefinitionBuilder transform(AttributeGetterDefinition decl, AttrTx attrTx) {
        ...
        final AttributeDefinitionBuilder builder = AttributeDefinitionBuilder
            .getter(this, name, decl.getDeclarationModel(), attrTx)
            .modifiers(transformAttributeGetSetDeclFlags(decl.getDeclarationModel(), attrTx));
        ...
        if (attrTx == AttrTx.BRIDGE_TO_STATIC) {
            JCStatement bridgeStmt = make().Return(make().Apply(null, 
                    naming.makeUnquotedIdent(Naming.getGetterName(decl.getDeclarationModel(), false)), 
                    List.<JCExpression>of(naming.makeThis())));
            builder.getterBlock(make().Block(0, List.<JCStatement>of(bridgeStmt)));
        } else if (Decl.withinClass(decl) || attrTx == AttrTx.COMPANION || useDefaultMethod(decl.getDeclarationModel())) {
    ...
    private AttributeDefinitionBuilder makeGetterOrSetter(Tree.AttributeDeclaration decl, AttrTx attrTx, boolean lazy, 
        ...
        at(decl);
        if (attrTx == AttrTx.COMPANION || attrTx == AttrTx.DEFAULT || lazy) {
    ...
    private AttributeDefinitionBuilder makeGetter(Tree.AttributeDeclaration decl, AttrTx attrTx, boolean lazy) {
        ...
        AttributeDefinitionBuilder getter = AttributeDefinitionBuilder
            .getter(this, attrName, decl.getDeclarationModel(), attrTx);
    ...
    private AttributeDefinitionBuilder makeSetter(Tree.AttributeDeclaration decl, AttrTx attrTx, boolean lazy) {
        at(decl);
        String attrName = decl.getIdentifier().getText();
        AttributeDefinitionBuilder setter = AttributeDefinitionBuilder.setter(this, decl, attrName, decl.getDeclarationModel(), attrTx);
    ...
    List<MethodDefinitionBuilder> transform(Tree.AnyMethod def,
        ...
        if (!Decl.withinInterface(model)) {
            ...
            result = transformMethod(def.getDeclarationModel(), 
                    ...
                    refinedResultType 
                        && !Decl.withinInterface(model.getRefinedDeclaration())? DaoKind.SUPER: DaoKind.THIS).toList();
    ...
    private ListBuffer<MethodDefinitionBuilder> transformMethod(
        ...
        boolean hasOverloads = transformParameterMethods(methodModel, method, body, daoKind, lb);
        
        if (transformMethod) {
            transformMethodItself(methodModel, method, actual, includeAnnotations, body, daoKind,
    ...
    protected boolean transformParameterMethods(final Function methodModel, Tree.AnyMethod method,
            List<JCStatement> body, DaoKind daoKind, 
            ListBuffer<MethodDefinitionBuilder> lb) {
            ...
            if (Strategy.hasDefaultParameterValueMethod(parameterModel)
                ...
                if (Decl.equal(refinedDeclaration, methodModel)
                    ...
                    if (Decl.equal(refinedDeclaration, methodModel)
                        ...
                        lb.append(makeParamDefaultValueMethod(daoKind, methodModel, parameterList, parameter));
                    }
                }
            }
        }
    ...
    protected void transformMethodItself(final Function methodModel, Tree.AnyMethod method, boolean actual,
            boolean includeAnnotations, List<JCStatement> body, DaoKind daoKind,
            Tree.ParameterList parameterList, ListBuffer<MethodDefinitionBuilder> lb, boolean hasOverloads) {
    ...
    abstract class DefaultedArgumentOverload {
        public final DaoKind kind;

        /**
         * @param daoBody for the body, or null if no body required
         */
        protected DefaultedArgumentOverload(DaoKind daoKind){
            this.kind = daoKind;
        }
        ...
        protected final List<JCExpression> makeTypeArguments() {
            if (kind == DaoKind.COMPANION) {
                ...
                if (defaultParameterMethodOnSelf() 
                    ...
                    Functional f = (Functional)getModel();
        ...
        protected void makeBody(
            ...
            case COMPANION:
                ...
                for (Parameter parameterModel : parameterList.getParameters()) {
                    ...
                    if (useDefault) {
                        at(parameterLocation(pl, parameterModel));
                        ...
                        if (Strategy.hasDefaultParameterValueMethod(parameterModel)) {
                            ...
                            initedVars = true;
                            JCExpression defaultValueMethodName = naming.makeDefaultedParamMethod(makeDefaultArgumentValueMethodQualifier(), parameterModel);
                            defaultArgument = make().Apply(makeTypeArguments(), 
                ...
                makeBody(node, pl, overloadBuilder, delegateArgs, vars);
                break;
            case SUPER:
                ListBuffer<JCExpression> args = new ListBuffer<JCExpression>();
                ...
                JCExpression superCall = makeInvocation(args);
                /*JCMethodInvocation superCall = make().Apply(null,
                        naming.makeQualIdent(naming.makeSuper(), ((Function)overloaded.getModel()).getName()),
                        args.toList());*/
                JCExpression refinedType = makeJavaType(((Function)getModel()).getType(), JT_NO_PRIMITIVES);
                overloadBuilder.body(make().Return(make().TypeCast(refinedType, superCall)));
                break;
            }
        }
        
        private Node parameterLocation(Tree.ParameterList pl, Parameter parameterModel) {
            if (pl != null) {
        ...
        private final void makeBody(
                Node declTree,
                Tree.ParameterList pl,
                MethodDefinitionBuilder overloadBuilder, 
                ListBuffer<JCExpression> args, 
                ListBuffer<JCStatement> vars) {
            Token firstExecutable = pl != null ? pl.getEndToken() : null;
            ...
            if (!isVoid(model)
                    ...
                    || Strategy.generateInstantiator(model) && this instanceof DefaultedArgumentInstantiator) {
                if (!vars.isEmpty()) {
    ...
    class DefaultedArgumentMethod extends DefaultedArgumentOverload {
        ...
        DefaultedArgumentMethod(DaoKind daoKind, Function method) {
            super(daoKind);
            this.method = method;
        }
    ...
    class DefaultedArgumentMethodTyped extends DefaultedArgumentMethod {
        ...
        DefaultedArgumentMethodTyped(DaoKind kind, Tree.ParameterList pl, TypedReference typedMember, boolean forMixin) {
            super(kind, (Function)typedMember.getDeclaration());
    ...
    class CanonicalMethod extends DefaultedArgumentMethod {
        ...
        CanonicalMethod(DaoKind daoKind, Function method, List<JCStatement> body) {
    ...
    /**
     * A transformation for generating a bridge to the <em>canonical method</em>
     * used by the defaulted argument overload methods
     */
    ...
    abstract class DefaultedArgumentClass extends DefaultedArgumentOverload {
        ...
        DefaultedArgumentClass(DaoKind daoKind, Class klass, Constructor constructor, boolean delegationConstructor) {
            super(daoKind);
            this.klass = klass;
    ...
    class DefaultedArgumentConstructor extends DefaultedArgumentClass {
        ...
        DefaultedArgumentConstructor(Class klass, Tree.ParameterList pl, boolean delegationConstructor) {
            super(DaoKind.THIS, klass, null, delegationConstructor);
        }
        
        DefaultedArgumentConstructor(Constructor constructor, Tree.ParameterList pl, boolean delegationConstructor) {
            super(DaoKind.THIS, (Class)constructor.getContainer(), constructor, delegationConstructor);
        }
        ...
        protected JCExpression makeMethodName() {
            return naming.makeQualifiedThis(makeMethodNameQualifier());
        }
    ...
    class DefaultedArgumentInstantiator extends DefaultedArgumentClass {
        ...
        DefaultedArgumentInstantiator(DaoKind kind, Class klass, Constructor ctor, boolean forCompanionClass) {
            super(kind, klass, ctor, false);
        ...
        @Override
        protected JCExpression makeMethodName() {
            return naming.makeInstantiatorMethodName(makeMethodNameQualifier(), klass);
        }
     ...
     */
    MethodDefinitionBuilder makeParamDefaultValueMethod(DaoKind daoKind, Declaration container, 
    ...
    private List<JCTree> transformObject(Node def,
        ...
        if (makeLocalInstance) {
            ...
            if (generateGetter) {
                ...
                AttributeDefinitionBuilder getter = AttributeDefinitionBuilder
                .getter(this, name, model, AttrTx.THIS)
