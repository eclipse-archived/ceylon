...
public class Util {
    ...
    public static String getQuotedFQN(String pkgName, org.eclipse.ceylon.compiler.typechecker.tree.Tree.Declaration decl) {
        ...
        return pkgName.isEmpty() ? name : org.eclipse.ceylon.compiler.java.util.Util.quoteJavaKeywords(pkgName) + "." + name;
    }
