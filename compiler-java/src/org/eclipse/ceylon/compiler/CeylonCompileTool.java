...
import org.eclipse.ceylon.common.tools.SourceDependencyResolver;
...
public class CeylonCompileTool extends OutputRepoUsingTool {
    ...
    private static final class Helper extends org.eclipse.ceylon.langtools.tools.javac.main.OptionHelper {
        ...
        @Override
        public String get(org.eclipse.ceylon.langtools.tools.javac.main.Option option) {
        ...
        @Override
        public List<String> getMulti(org.eclipse.ceylon.langtools.tools.javac.main.Option option) {
    ...
    public void setTarget(Long version) {
        validateWithJavac(org.eclipse.ceylon.langtools.tools.javac.main.Option.TARGET, "-target", version.toString());
        validateWithJavac(org.eclipse.ceylon.langtools.tools.javac.main.Option.SOURCE, "-source", version.toString());
    ...
    private void validateWithJavac(org.eclipse.ceylon.langtools.tools.javac.main.Option option, String argument, String value) {
    ...
    public static void addJavacArguments(List<String> arguments, List<String> javac) {
        ...
        for (String argument : javac) {
            ...
            if (index != -1 &&
                    !org.eclipse.ceylon.langtools.tools.javac.main.Option.A.matches(argument)) {
                value = index < argument.length() ? argument.substring(index+1) : "";
                argument = argument.substring(0, index);
            }
            
            org.eclipse.ceylon.langtools.tools.javac.main.Option javacOpt = getJavacOpt(argument);
            if (javacOpt == null) {
    ...
    private static org.eclipse.ceylon.langtools.tools.javac.main.Option getJavacOpt(String optionName) {
        for (org.eclipse.ceylon.langtools.tools.javac.main.Option o : org.eclipse.ceylon.langtools.tools.javac.main.Option.getJavaCompilerOptions()) {
