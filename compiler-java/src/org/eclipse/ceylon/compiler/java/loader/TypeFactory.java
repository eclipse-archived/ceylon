...
public class TypeFactory extends Unit {
    ...
    public static TypeFactory instance(org.eclipse.ceylon.langtools.tools.javac.util.Context context) {
    ...
    public Interface getJavaIoSerializable() {
        for (org.eclipse.ceylon.model.typechecker.model.Module m : context.getModules().getListOfModules()) {
