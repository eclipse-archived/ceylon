...
public class CompilerModuleManager extends LazyModuleManager {
    ...
    private org.eclipse.ceylon.langtools.tools.javac.util.Context context;
    private CeylonEnter ceylonEnter;
    private CeylonModelLoader modelLoader;

    public CompilerModuleManager(Context ceylonContext, org.eclipse.ceylon.langtools.tools.javac.util.Context context) {
