...
import static org.eclipse.ceylon.javax.tools.StandardLocation.CLASS_PATH;
import static org.eclipse.ceylon.javax.tools.StandardLocation.PLATFORM_CLASS_PATH;
...
import org.eclipse.ceylon.compiler.java.loader.mirror.JavacClass;
import org.eclipse.ceylon.compiler.java.loader.mirror.JavacMethod;
import org.eclipse.ceylon.compiler.java.loader.mirror.JavacType;
...
import org.eclipse.ceylon.langtools.tools.javac.code.Scope.Entry;
...
import org.eclipse.ceylon.langtools.tools.javac.code.Types.FunctionDescriptorLookupError;
...
public class CeylonModelLoader extends AbstractModelLoader {
    ...
    private boolean overloaded(MethodSymbol m, TypeSymbol c, Types types) {
        for (org.eclipse.ceylon.langtools.tools.javac.util.List<Type> is = types.interfaces(c.type);
             is.nonEmpty();
             is = is.tail) {
            TypeSymbol i = is.head.tsym;
    ...
    private boolean isGetter(MethodSymbol methodSymbol) {
        ...
        boolean hasNonVoidReturn = (methodSymbol.getReturnType().getKind() != org.eclipse.ceylon.javax.lang.model.type.TypeKind.VOID);
        boolean hasBooleanReturn = (methodSymbol.getReturnType().getKind() == org.eclipse.ceylon.javax.lang.model.type.TypeKind.BOOLEAN);
