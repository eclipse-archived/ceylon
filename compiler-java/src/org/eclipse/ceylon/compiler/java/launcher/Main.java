...
package org.eclipse.ceylon.compiler.java.launcher;

import static org.eclipse.ceylon.langtools.tools.javac.main.Main.Result.*;
...
import org.eclipse.ceylon.common.tools.SourceArgumentsResolver;
import org.eclipse.ceylon.compiler.java.launcher.Main.ExitState.CeylonState;
import org.eclipse.ceylon.compiler.java.tools.CeylonLocation;
...
import org.eclipse.ceylon.compiler.java.util.Timer;
...
import org.eclipse.ceylon.langtools.tools.javac.code.Source;
...
import org.eclipse.ceylon.langtools.tools.javac.main.CommandLine;
...
import org.eclipse.ceylon.langtools.tools.javac.processing.AnnotationProcessingError;
...
import org.eclipse.ceylon.langtools.tools.javac.util.FatalError;
...
import org.eclipse.ceylon.langtools.tools.javac.util.PropagatedException;
 ...
 */
public class Main extends org.eclipse.ceylon.langtools.tools.javac.main.Main {
    ...
    public static class ExitState {
        ...
        private static boolean isAbnormalException(Throwable ex) {
            ...
            if (ex instanceof RuntimeException
                    ...
                    && !ex.getClass().getName().startsWith("org.eclipse.ceylon.")
                    // And neither are CCEs from the javac code abnormal
                    && !(ex instanceof ClassCastException && ex.getMessage() != null && ex.getMessage().contains("org.eclipse.ceylon.langtools."))
    ...
    private static final String javacBundleName = "org.eclipse.ceylon.langtools.tools.javac.resources.ceylonc";
