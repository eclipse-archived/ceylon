...
public class Main extends org.eclipse.ceylon.langtools.tools.javac.Main {
    ...
    public static int compile(String[] args, PrintWriter writer) {
        org.eclipse.ceylon.compiler.java.launcher.Main compiler = new org.eclipse.ceylon.compiler.java.launcher.Main("ceylonc", writer);
        return compiler.compile(args).exitCode;
    }
