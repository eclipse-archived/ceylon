...
public class Naming extends NamingBase implements LocalId {
    ...
    private static final List<String> ORG_ECLIPSE_CEYLON_LANGUAGE_PACKAGE = 
            Arrays.asList(new String[]{"org", "eclipse", "ceylon", "compiler", "java", "language"});
        ...
        if (flags.contains(DeclNameFlag.QUALIFIED) && (!decl.isAnonymous() || decl.isNamed())) {
            final List<String> packageName = 
                    ...
                    AbstractTransformer.isJavaInterop(decl) ? 
                            ORG_ECLIPSE_CEYLON_LANGUAGE_PACKAGE : 
                                ((Package) s).getName();
    ...
    private static void appendClassName(StringBuilder b, org.eclipse.ceylon.compiler.typechecker.tree.Tree.Declaration decl) {
    ...
    JCExpression makeCompanionAccessorCall(JCExpression qualExpr, Interface def) {
        return make().Apply(null, 
                ...
                org.eclipse.ceylon.langtools.tools.javac.util.List.<JCExpression>nil());
    }
    ...
    class Substitution implements AutoCloseable {
        ...
        public void scopeClose(Scope scope) {
            ...
            this.scoped = true;
            org.eclipse.ceylon.langtools.tools.javac.util.List<Substitution> list = scopedSubstitutions.get(scope);
            if (list == null) {
                list = org.eclipse.ceylon.langtools.tools.javac.util.List.<Substitution>nil();
            }
    ...
    private Map<Scope, org.eclipse.ceylon.langtools.tools.javac.util.List<Substitution>> scopedSubstitutions = new HashMap<>();
    
    public void closeScopedSubstitutions(Scope scope) {
        org.eclipse.ceylon.langtools.tools.javac.util.List<Substitution> substitutions = scopedSubstitutions.remove(scope);
        ...
        for (Map.Entry<Scope, org.eclipse.ceylon.langtools.tools.javac.util.List<Substitution>> entry : scopedSubstitutions.entrySet()) {
