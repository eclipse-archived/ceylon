...
import org.eclipse.ceylon.langtools.classfile.ClassWriter;
...
import org.eclipse.ceylon.langtools.classfile.ModulePackages_attribute;
...
public class Java9Util {
    ...
    static class Java9ModuleDescriptor {
        ...
        private boolean skipModuleImport(String dependency) {
            ...
            if(name.equals("org.eclipse.ceylon.model") && dependency.equals(Module.LANGUAGE_MODULE_NAME))
                return true;
            // same for slf4j
        ...
        private String getMain(String module) {
            if(module.equals("org.eclipse.ceylon.java.main"))
                return "org.eclipse.ceylon.compiler.java.runtime.Main2";
            else 
                return null;
        }
        ...
        private boolean isShared(Package pkg) {
            ...
            if(pkg.getModule().isLanguageModule()){
                ...
                if(name.equals("org.eclipse.ceylon.compiler.java.runtime.metamodel")
                        || name.equals("org.eclipse.ceylon.compiler.java.runtime")
                        || name.equals("org.eclipse.ceylon.compiler.java.metadata")
                        || name.equals("org.eclipse.ceylon.compiler.java"))
                    return true;
            }
            return pkg.isShared();
        }
    ...
    private static ClassFile generateModuleDescriptor(Java9ModuleDescriptor module) {
        ...
        return new ClassFile(org.eclipse.ceylon.langtools.tools.javac.jvm.ClassFile.JAVA_MAGIC,
                org.eclipse.ceylon.langtools.tools.javac.jvm.ClassFile.Version.V53.minor,
                org.eclipse.ceylon.langtools.tools.javac.jvm.ClassFile.Version.V53.major,
                constantPool,
                new org.eclipse.ceylon.langtools.classfile.AccessFlags(org.eclipse.ceylon.langtools.classfile.AccessFlags.ACC_MODULE),
                2,
                0,
                new int[0],
                new org.eclipse.ceylon.langtools.classfile.Field[0],
                new org.eclipse.ceylon.langtools.classfile.Method[0],
                attributes);
    }
