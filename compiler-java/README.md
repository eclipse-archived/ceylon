...
Once built, the compiler lives in this jar:
    ...
    ~/.ceylon/repo/com/redhat/ceylon/compiler/java/0.4/com.redhat.ceylon.compiler.java-0.4.jar
...
4) Build it (ant clean publish)
    ...
    publish:
        [copy] Copying 2 files to /Users/alesj/.ceylon/repo/com/redhat/ceylon/compiler/java/0.4
        [copy] Copying 2 files to /Users/alesj/.ceylon/repo/com/redhat/ceylon/ant/0.4
