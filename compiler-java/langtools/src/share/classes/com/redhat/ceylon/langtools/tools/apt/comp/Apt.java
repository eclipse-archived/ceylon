...
package com.redhat.ceylon.langtools.tools.apt.comp;

import java.util.*;
import java.util.regex.*;

import com.redhat.ceylon.langtools.mirror.apt.*;
import com.redhat.ceylon.langtools.mirror.declaration.AnnotationTypeDeclaration;
import com.redhat.ceylon.langtools.mirror.declaration.TypeDeclaration;
import com.redhat.ceylon.langtools.tools.apt.*;
import com.redhat.ceylon.langtools.tools.apt.comp.*;
import com.redhat.ceylon.langtools.tools.apt.mirror.AptEnv;
import com.redhat.ceylon.langtools.tools.apt.mirror.apt.AnnotationProcessorEnvironmentImpl;
import com.redhat.ceylon.langtools.tools.apt.mirror.apt.FilerImpl;
...
import static com.redhat.ceylon.langtools.tools.apt.mirror.declaration.DeclarationMaker.isJavaIdentifier;
...
public class Apt extends ListBuffer<Env<AttrContext>> {
    ...
    public void main(com.redhat.ceylon.langtools.tools.javac.util.List<JCTree.JCCompilationUnit> treeList,
    ...
    Pattern importStringToPattern(String s) {
        if (com.redhat.ceylon.langtools.tools.javac.processing.JavacProcessingEnvironment.isValidImportString(s)) {
            return com.redhat.ceylon.langtools.tools.javac.processing.JavacProcessingEnvironment.validImportStringToPattern(s);
        } else {
            Bark bark = Bark.instance(context);
            bark.aptWarning("MalformedSupportedString", s);
            return com.redhat.ceylon.langtools.tools.javac.processing.JavacProcessingEnvironment.noMatches;
        }
    }
}
