...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
      if (args.length > 0 && args[0].equals("-Xjdb")) {
        ...
        newargs[0] = "-connect";
        newargs[1] = "com.redhat.ceylon.langtools.jdi.CommandLineLaunch:options=-esa -ea:com.redhat.ceylon.langtools.tools...";
    ...
    public static int compile(String[] args) {
        com.redhat.ceylon.langtools.tools.javac.main.Main compiler =
            new com.redhat.ceylon.langtools.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        com.redhat.ceylon.langtools.tools.javac.main.Main compiler =
            new com.redhat.ceylon.langtools.tools.javac.main.Main("javac", out);
        return compiler.compile(args);
    }
}
