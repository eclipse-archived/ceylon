...
import static com.redhat.ceylon.langtools.tools.javac.file.Paths.pathToURLs;
...
import com.redhat.ceylon.langtools.mirror.apt.AnnotationProcessorFactory;
import com.redhat.ceylon.langtools.tools.apt.comp.AnnotationProcessingError;
import com.redhat.ceylon.langtools.tools.apt.comp.UsageMessageNeededException;
...
public class Main {
    ...
    public int compile(String[] args, AnnotationProcessorFactory factory) {
        ...
        if (options.get("-nocompile") == null &&
            ...
            returnCode = com.redhat.ceylon.langtools.tools.javac.Main.compile(newArgs);
        }
    ...
    private static final String aptRB =
        "com.redhat.ceylon.langtools.tools.apt.resources.apt";
