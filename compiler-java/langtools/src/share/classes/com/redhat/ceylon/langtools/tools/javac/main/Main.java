...
public class Main {
    ...
    public Collection<File> processArgs(String[] flags, String[] classNames) { // XXX sb protected
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "com.redhat.ceylon.langtools.tools.javac.Main";
            showClass(showClass);
        }
                          ...
                          Iterable<? extends Processor> processors)
    {
        ...
        try {
            ...
            // as specified by com.redhat.ceylon.javax.tools.JavaCompiler#getTask
            // and com.redhat.ceylon.javax.tools.JavaCompiler.CompilationTask#call
            throw new RuntimeException(ex.getCause());
