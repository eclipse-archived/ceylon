...
import com.redhat.ceylon.langtools.tools.javac.comp.DeferredAttr.AttrMode;
import com.redhat.ceylon.langtools.tools.javac.comp.Infer.InferenceContext;
import com.redhat.ceylon.langtools.tools.javac.comp.Infer.FreeTypeListener;
...
import static com.redhat.ceylon.langtools.tools.javac.code.TypeTag.WILDCARD;
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * com.redhat.ceylon.langtools.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
