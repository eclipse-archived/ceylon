...
package com.redhat.ceylon.langtools.tools.javadoc;

import static com.redhat.ceylon.langtools.tools.javac.code.TypeTags.*;

import com.redhat.ceylon.langtools.javadoc.*;
...
public class TypeMaker {
    ...
    public static com.redhat.ceylon.langtools.javadoc.Type getType(DocEnv env, Type t) {
     ...
     */
    public static com.redhat.ceylon.langtools.javadoc.Type[] getTypes(DocEnv env, List<Type> ts) {
        return getTypes(env, ts, new com.redhat.ceylon.langtools.javadoc.Type[ts.length()]);
    }
     ...
     */
    public static com.redhat.ceylon.langtools.javadoc.Type[] getTypes(DocEnv env, List<Type> ts,
                                                  com.redhat.ceylon.langtools.javadoc.Type res[]) {
        int i = 0;
        for (Type t : ts) {
            res[i++] = getType(env, t);
        }
    ...
    private static class ArrayTypeImpl implements com.redhat.ceylon.langtools.javadoc.Type {
        ...
        private com.redhat.ceylon.langtools.javadoc.Type skipArraysCache = null;

        private com.redhat.ceylon.langtools.javadoc.Type skipArrays() {
