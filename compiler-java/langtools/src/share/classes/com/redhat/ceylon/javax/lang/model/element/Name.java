 ...
 * com.redhat.ceylon.javax.annotation.processing.ProcessingEnvironment annotation
 * processing}, the guarantees for "the same" implementation must
 * include contexts where the {@linkplain com.redhat.ceylon.javax.annotation.processing
 * API mediated} side effects of {@linkplain
 * com.redhat.ceylon.javax.annotation.processing.Processor processors} could be visible
 * to each other, including successive annotation processing
 * {@linkplain com.redhat.ceylon.javax.annotation.processing.RoundEnvironment rounds}.
 *
 * @author Joseph D. Darcy
 * @author Scott Seligman
 * @author Peter von der Ah&eacute;
 * @see com.redhat.ceylon.javax.lang.model.util.Elements#getName
 * @since 1.6
 */
