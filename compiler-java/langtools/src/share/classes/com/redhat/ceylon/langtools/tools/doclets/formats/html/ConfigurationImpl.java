...
public class ConfigurationImpl extends Configuration {
     ...
     * {@link com.redhat.ceylon.langtools.tools.doclets.MessageRetriever}.
     */
    private ConfigurationImpl() {
        standardmessage = new MessageRetriever(this,
            "com.redhat.ceylon.langtools.tools.doclets.formats.html.resources.standard");
    }
    ...
    public Locale getLocale() {
        if (root instanceof com.redhat.ceylon.langtools.tools.javadoc.RootDocImpl)
            return ((com.redhat.ceylon.langtools.tools.javadoc.RootDocImpl)root).getLocale();
        else
