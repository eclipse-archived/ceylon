...
package com.redhat.ceylon.langtools.tools.apt;
...
public class Main {
    ...
    static {
        ...
        if (loader != null)
            loader.setPackageAssertionStatus("com.redhat.ceylon.langtools.tools.apt", true);
    }
    ...
    private static int processing(AnnotationProcessorFactory factory,
        ...
        com.redhat.ceylon.langtools.tools.apt.main.Main compiler =
            new com.redhat.ceylon.langtools.tools.apt.main.Main("apt", out);
