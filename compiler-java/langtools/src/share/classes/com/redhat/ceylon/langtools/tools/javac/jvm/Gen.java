...
import com.redhat.ceylon.langtools.tools.javac.jvm.Items.*;
...
import static com.redhat.ceylon.langtools.tools.javac.jvm.CRTFlags.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        boolean initOrClinit = code.meth.getKind() == com.redhat.ceylon.javax.lang.model.element.ElementKind.CONSTRUCTOR
                || code.meth.getKind() == com.redhat.ceylon.javax.lang.model.element.ElementKind.STATIC_INIT;
        ...
        for (Symbol s : new com.redhat.ceylon.langtools.tools.javac.model.FilteredMemberList(clazz.members())) {
