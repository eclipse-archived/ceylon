...
public class ZipFileIndex {
     ...
     */
    public synchronized com.redhat.ceylon.langtools.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            com.redhat.ceylon.langtools.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return com.redhat.ceylon.langtools.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            com.redhat.ceylon.langtools.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private com.redhat.ceylon.langtools.tools.javac.util.List<String> zipFileEntriesFiles = com.redhat.ceylon.langtools.tools.javac.util.List.<String>nil();
        private com.redhat.ceylon.langtools.tools.javac.util.List<String> zipFileEntriesDirectories = com.redhat.ceylon.langtools.tools.javac.util.List.<String>nil();
        private com.redhat.ceylon.langtools.tools.javac.util.List<Entry>  zipFileEntries = com.redhat.ceylon.langtools.tools.javac.util.List.<Entry>nil();
        ...
        private com.redhat.ceylon.langtools.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private com.redhat.ceylon.langtools.tools.javac.util.List<String> getDirectories() {
        ...
        private com.redhat.ceylon.langtools.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = com.redhat.ceylon.langtools.tools.javac.util.List.nil();
