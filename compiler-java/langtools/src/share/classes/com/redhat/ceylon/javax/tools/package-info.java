 ...
 * ({@linkplain com.redhat.ceylon.javax.tools.DiagnosticListener}) as well as a file
 * abstraction for overriding file access ({@linkplain
 * com.redhat.ceylon.javax.tools.JavaFileManager} and {@linkplain
 * com.redhat.ceylon.javax.tools.JavaFileObject}).  See {@linkplain
 * com.redhat.ceylon.javax.tools.JavaCompiler} for more details on using the SPI.
 *
 * <p>There is no requirement for a compiler at runtime.  However, if
 * a default compiler is provided, it can be located using the
 * {@linkplain com.redhat.ceylon.javax.tools.ToolProvider}, for example:
 *
