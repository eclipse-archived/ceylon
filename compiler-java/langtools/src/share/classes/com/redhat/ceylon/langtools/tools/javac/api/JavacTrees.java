...
public class JavacTrees extends Trees {
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof com.redhat.ceylon.langtools.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (com.redhat.ceylon.langtools.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
     ...
     */
    public TypeMirror getOriginalType(com.redhat.ceylon.javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof com.redhat.ceylon.langtools.tools.javac.code.Type.ErrorType) {
            return ((com.redhat.ceylon.langtools.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return com.redhat.ceylon.langtools.tools.javac.code.Type.noType;
    }
