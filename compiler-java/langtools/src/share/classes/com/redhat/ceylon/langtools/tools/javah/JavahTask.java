...
import static com.redhat.ceylon.javax.tools.Diagnostic.Kind.*;
...
//                throw new BadArgs("jni.no.stubs");
    ...
    private static final String versionRBName = "com.redhat.ceylon.langtools.tools.javah.resources.version";
    ...
    private String getMessage(Locale locale, String key, Object... args) {
        ...
        if (b == null) {
            try {
                b = ResourceBundle.getBundle("com.redhat.ceylon.langtools.tools.javah.resources.l10n", locale);
