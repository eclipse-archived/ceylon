...
public class SourceToHTMLConverter {
    ...
    public static void convertClass(ConfigurationImpl configuration, ClassDoc cd,
        ...
        try {
            ...
            if (sp instanceof com.redhat.ceylon.langtools.tools.javadoc.SourcePositionImpl) {
                FileObject fo = ((com.redhat.ceylon.langtools.tools.javadoc.SourcePositionImpl) sp).fileObject();
                if (fo == null)
                    return;
