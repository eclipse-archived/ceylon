...
import static org.eclipse.ceylon.langtools.tools.javac.comp.Resolve.MethodResolutionPhase.*;
...
import org.eclipse.ceylon.langtools.tools.javac.api.Formattable.LocalizedString;
...
import org.eclipse.ceylon.langtools.tools.javac.comp.Attr.ResultInfo;
...
import org.eclipse.ceylon.langtools.tools.javac.comp.DeferredAttr.DeferredType;
...
import org.eclipse.ceylon.langtools.tools.javac.comp.Resolve.MethodResolutionContext.Candidate;
import org.eclipse.ceylon.langtools.tools.javac.comp.Resolve.MethodResolutionDiagHelper.DiagnosticRewriter;
import org.eclipse.ceylon.langtools.tools.javac.comp.Resolve.MethodResolutionDiagHelper.Template;
...
import org.eclipse.ceylon.langtools.tools.javac.tree.JCTree.JCMemberReference.ReferenceKind;
 ...
 *************************************************************************/
    ...
    static boolean isInitializer(Env<AttrContext> env) {
        ...
        return owner.isConstructor() ||
            ...
            (owner.kind == VAR ||
             owner.kind == MTH && (owner.flags() & Flags.BLOCK) != 0) &&
 ...
 ****************************************************************************/
    ...
    Symbol selectBest(Env<AttrContext> env,
        ...
        if (sym.kind == ERR ||
            ...
            return bestSoFar.kind >= Kinds.ERRONEOUS ?
        ...
        try {
            ...
            if (modelLoader != null && !sourceLanguage.isCeylon()) {
                ...
                if(!nameString.equals("java.lang.String")
                        ...
                        && !nameString.equals("org.eclipse.ceylon.common.Nullable")
                        && !nameString.equals("org.eclipse.ceylon.common.NonNull")
                        ){
 ...
 ****************************************************************************/
    ...
    Symbol resolveMemberReferenceByArity(Env<AttrContext> env,
        ...
        if (isStaticSelector) {
            ...
            if (unboundSym.isStatic() &&
                unboundSym.kind < Kinds.ERRONEOUS) {
    ...
    abstract class LookupHelper {
        ...
        final boolean shouldStop(Symbol sym, MethodResolutionPhase phase) {
            return phase.ordinal() > maxPhase.ordinal() ||
                    sym.kind < Kinds.ERRONEOUS || sym.kind == AMBIGUOUS;
        }
    ...
    boolean hasEnclosingInstance(Env<AttrContext> env, Type type) {
        ...
        return encl != null && encl.kind < Kinds.ERRONEOUS;
    }
 ...
 ****************************************************************************/
    ...
    abstract class InvalidSymbolError extends ResolveError {
        ...
        public Symbol access(Name name, TypeSymbol location) {
            if ((sym.kind & Kinds.ERRONEOUS) == 0 && (sym.kind & TYP) != 0)
    ...
    enum MethodResolutionPhase {
        ...
        VARARITY(true, true) {
            ...
            public Symbol mergeResults(Symbol bestSoFar, Symbol sym) {
                ...
                Assert.check(bestSoFar.kind >= Kinds.ERRONEOUS && bestSoFar.kind != AMBIGUOUS);
                if (sym.kind < Kinds.ERRONEOUS) {
