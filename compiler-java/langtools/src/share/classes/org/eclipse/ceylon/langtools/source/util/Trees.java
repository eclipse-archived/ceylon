...
package org.eclipse.ceylon.langtools.source.util;
...
import org.eclipse.ceylon.langtools.source.tree.ClassTree;
import org.eclipse.ceylon.langtools.source.tree.CompilationUnitTree;
import org.eclipse.ceylon.langtools.source.tree.MethodTree;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("org.eclipse.ceylon.langtools.tools.javac.api.JavacTaskImpl")
                && !taskClassName.equals("org.eclipse.ceylon.langtools.tools.javac.api.BasicJavacTask"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("org.eclipse.ceylon.langtools.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("org.eclipse.ceylon.langtools.tools.javac.api.JavacTrees", false, cl);
    ...
    /**
      ...
      * @return org.eclipse.ceylon.javax.lang.model.type.TypeMirror corresponding to the original type, replaced by the ErrorType.
      */
