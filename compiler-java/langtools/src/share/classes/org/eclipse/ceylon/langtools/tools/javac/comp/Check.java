...
import org.eclipse.ceylon.langtools.tools.javac.comp.DeferredAttr.DeferredAttrContext;
 ...
 **************************************************************************/
    ...
    private boolean checkExtends(Type a, Type bound) {
         if (a.isUnbound()) {
             return true;
         } else if (!a.hasTag(TypeTag.WILDCARD)) {
    ...
    Type checkClassType(DiagnosticPosition pos, Type t, boolean noBounds) {
        ...
        if (noBounds && t.isParameterized()) {
            ...
            while (args.nonEmpty()) {
                if (args.head.hasTag(TypeTag.WILDCARD))
                    return typeTagError(pos,
    ...
    long checkFlags(DiagnosticPosition pos, long flags, Symbol sym, JCTree tree) {
        ...
        case MTH:
            if (sym.name == names.init) {
                ...
                if ((sym.owner.flags_field & Flags.ANNOTATION) != 0) {
        ...
        if (illegal != 0) {
            if ((illegal & INTERFACE) != 0) {
                ...
                log.error(pos,
                 ...
                 checkDisjoint(pos, flags,
                               ABSTRACT | INTERFACE,
                               FINAL | NATIVE | Flags.SYNCHRONIZED)
                 &&
                 checkDisjoint(pos, flags,
                               PUBLIC,
                               PRIVATE | PROTECTED)
 ...
 **************************************************************************/
    ...
    void checkOverride(JCTree tree,
        ...
        if ((m.owner.flags() & Flags.ANNOTATION) != 0) {
    ...
    public void checkClassOverrideEqualsAndHashIfNeeded(DiagnosticPosition pos,
        ...
        if (someClass == (ClassSymbol)syms.objectType.tsym ||
            ...
            (someClass.flags() & Flags.ANNOTATION) != 0 ||
 ...
 **************************************************************************/
    ...
    private void validateAnnotation(JCAnnotation a, Symbol s) {
        ...
        if (a.annotationType.type.tsym == syms.functionalInterfaceType.tsym) {
            ...
            } else if (!s.isInterface() || (s.flags() & Flags.ANNOTATION) != 0) {
    ...
    boolean annotationApplicable(JCAnnotation a, Symbol s) {
        ...
        for (Name target : targets) {
            if (target == names.TYPE)
                ...
                { if (s.kind == TYP && (s.flags() & Flags.ANNOTATION) != 0)
                    return true;
                }
 ...
 **************************************************************************/
    ...
    void checkNonCyclicElements(JCClassDecl tree) {
        if ((tree.sym.flags_field & Flags.ANNOTATION) == 0) return;
