 ...
 * ({@linkplain org.eclipse.ceylon.javax.tools.DiagnosticListener}) as well as a file
 * abstraction for overriding file access ({@linkplain
 * org.eclipse.ceylon.javax.tools.JavaFileManager} and {@linkplain
 * org.eclipse.ceylon.javax.tools.JavaFileObject}).  See {@linkplain
 * org.eclipse.ceylon.javax.tools.JavaCompiler} for more details on using the SPI.
 *
 * <p>There is no requirement for a compiler at runtime.  However, if
 * a default compiler is provided, it can be located using the
 * {@linkplain org.eclipse.ceylon.javax.tools.ToolProvider}, for example:
 *
 ...
 * META-INF/services/org.eclipse.ceylon.javax.tools.JavaCompiler}.  This file would
