...
public class ZipFileIndex {
     ...
     */
    public synchronized org.eclipse.ceylon.langtools.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            org.eclipse.ceylon.langtools.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return org.eclipse.ceylon.langtools.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            org.eclipse.ceylon.langtools.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private org.eclipse.ceylon.langtools.tools.javac.util.List<String> zipFileEntriesFiles = org.eclipse.ceylon.langtools.tools.javac.util.List.<String>nil();
        private org.eclipse.ceylon.langtools.tools.javac.util.List<String> zipFileEntriesDirectories = org.eclipse.ceylon.langtools.tools.javac.util.List.<String>nil();
        private org.eclipse.ceylon.langtools.tools.javac.util.List<Entry>  zipFileEntries = org.eclipse.ceylon.langtools.tools.javac.util.List.<Entry>nil();
        ...
        private org.eclipse.ceylon.langtools.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private org.eclipse.ceylon.langtools.tools.javac.util.List<String> getDirectories() {
        ...
        private org.eclipse.ceylon.langtools.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = org.eclipse.ceylon.langtools.tools.javac.util.List.nil();
