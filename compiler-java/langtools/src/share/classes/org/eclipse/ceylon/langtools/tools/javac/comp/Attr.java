...
package org.eclipse.ceylon.langtools.tools.javac.comp;

import static org.eclipse.ceylon.langtools.tools.javac.code.Flags.*;
import static org.eclipse.ceylon.langtools.tools.javac.code.Kinds.*;
import static org.eclipse.ceylon.langtools.tools.javac.code.TypeTag.*;
import static org.eclipse.ceylon.langtools.tools.javac.tree.JCTree.Tag.*;

import java.util.*;

import org.eclipse.ceylon.javax.lang.model.element.ElementKind;
import org.eclipse.ceylon.javax.tools.JavaFileObject;
import org.eclipse.ceylon.langtools.source.tree.IdentifierTree;
import org.eclipse.ceylon.langtools.source.tree.MemberSelectTree;
import org.eclipse.ceylon.langtools.source.tree.TreeVisitor;
import org.eclipse.ceylon.langtools.source.tree.MemberReferenceTree.ReferenceMode;
import org.eclipse.ceylon.langtools.source.util.SimpleTreeVisitor;
import org.eclipse.ceylon.langtools.tools.javac.code.*;
import org.eclipse.ceylon.langtools.tools.javac.code.Lint.LintCategory;
import org.eclipse.ceylon.langtools.tools.javac.code.Scope.DelegatedScope;
import org.eclipse.ceylon.langtools.tools.javac.code.Symbol.*;
import org.eclipse.ceylon.langtools.tools.javac.code.Type.*;
import org.eclipse.ceylon.langtools.tools.javac.comp.Check.CheckContext;
import org.eclipse.ceylon.langtools.tools.javac.comp.DeferredAttr.AttrMode;
import org.eclipse.ceylon.langtools.tools.javac.comp.Infer.FreeTypeListener;
import org.eclipse.ceylon.langtools.tools.javac.comp.Infer.InferenceContext;
...
import org.eclipse.ceylon.langtools.tools.javac.tree.JCTree.JCPolyExpression.*;
            ...
            public Type visitIntersectionClassType(IntersectionClassType ict, DiagnosticPosition pos) {
                ...
                for (Type bound : ict.getExplicitComponents()) {
                    ...
                    if (types.isFunctionalInterface(boundSym) &&
                        ...
                        target = bound;
                    } else if (!boundSym.isInterface() || (boundSym.flags() & Flags.ANNOTATION) != 0) {
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * org.eclipse.ceylon.langtools.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
