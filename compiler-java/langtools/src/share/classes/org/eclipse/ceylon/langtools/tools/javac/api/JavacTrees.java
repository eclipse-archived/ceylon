...
import static org.eclipse.ceylon.langtools.tools.javac.code.TypeTag.ARRAY;
import static org.eclipse.ceylon.langtools.tools.javac.code.TypeTag.CLASS;
...
import org.eclipse.ceylon.langtools.source.tree.CatchTree;
import org.eclipse.ceylon.langtools.source.tree.CompilationUnitTree;
import org.eclipse.ceylon.langtools.source.tree.Scope;
import org.eclipse.ceylon.langtools.source.tree.Tree;
import org.eclipse.ceylon.langtools.source.util.JavacTask;
import org.eclipse.ceylon.langtools.source.util.SourcePositions;
import org.eclipse.ceylon.langtools.source.util.TreePath;
import org.eclipse.ceylon.langtools.source.util.Trees;
...
import org.eclipse.ceylon.langtools.tools.javac.code.Symbol.MethodSymbol;
import org.eclipse.ceylon.langtools.tools.javac.code.Symbol.TypeSymbol;
import org.eclipse.ceylon.langtools.tools.javac.code.Symbol.VarSymbol;
import org.eclipse.ceylon.langtools.tools.javac.code.Type.ArrayType;
import org.eclipse.ceylon.langtools.tools.javac.code.Type.ClassType;
import org.eclipse.ceylon.langtools.tools.javac.code.Type.ErrorType;
import org.eclipse.ceylon.langtools.tools.javac.code.Type.UnionClassType;
import org.eclipse.ceylon.langtools.tools.javac.code.Types.TypeRelation;
import org.eclipse.ceylon.langtools.tools.javac.comp.Attr;
...
import org.eclipse.ceylon.langtools.tools.javac.comp.MemberEnter;
import org.eclipse.ceylon.langtools.tools.javac.comp.Resolve;
import org.eclipse.ceylon.langtools.tools.javac.model.JavacElements;
import org.eclipse.ceylon.langtools.tools.javac.processing.JavacProcessingEnvironment;
...
import org.eclipse.ceylon.langtools.tools.javac.tree.TreeInfo;
...
import org.eclipse.ceylon.langtools.tools.javac.util.Assert;
...
import org.eclipse.ceylon.langtools.tools.javac.util.Pair;
...
public class JavacTrees extends Trees {
    ...
    private VarSymbol searchField(ClassSymbol tsym, Name fieldName, Set<ClassSymbol> searched) {
        ...
        for (org.eclipse.ceylon.langtools.tools.javac.code.Scope.Entry e = tsym.members().lookup(fieldName);
    ...
    MethodSymbol findConstructor(ClassSymbol tsym, List<Type> paramTypes) {
        for (org.eclipse.ceylon.langtools.tools.javac.code.Scope.Entry e = tsym.members().lookup(names.init);
                e.scope != null; e = e.next()) {
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof org.eclipse.ceylon.langtools.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (org.eclipse.ceylon.langtools.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
     ...
     */
    public TypeMirror getOriginalType(org.eclipse.ceylon.javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof org.eclipse.ceylon.langtools.tools.javac.code.Type.ErrorType) {
            return ((org.eclipse.ceylon.langtools.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return org.eclipse.ceylon.langtools.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            org.eclipse.ceylon.langtools.source.tree.Tree t,
            org.eclipse.ceylon.langtools.source.tree.CompilationUnitTree root) {
