...
import org.eclipse.ceylon.langtools.tools.javac.tree.JCTree.JCLambda;
...
*/
// Code duplicated in org.eclipse.ceylon.langtools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // In org.eclipse.ceylon.langtools.tools.javac.jvm.Gen.genCatch we first set the type_index
    // to the catch type index - that value is only temporary.
    // Then in org.eclipse.ceylon.langtools.tools.javac.jvm.Code.fillExceptionParameterPositions
