...
package org.eclipse.ceylon.langtools.tools.javac.code;

import static org.eclipse.ceylon.langtools.tools.javac.code.Flags.*;
import static org.eclipse.ceylon.langtools.tools.javac.code.TypeTag.*;
import static org.eclipse.ceylon.langtools.tools.javac.jvm.ByteCodes.*;
...
import org.eclipse.ceylon.langtools.tools.javac.jvm.*;
...
public class Symtab {
    ...
    public  Type ceylonConstantIterableType;
    ...
    public final Type ceylonAtNullableType;
    public final Type ceylonAtNonNullType;
    ...
    protected Symtab(Context context) throws CompletionFailure {
        ...
        ceylonAtCeylonType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Ceylon");
        ceylonAtDynamicType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Dynamic");
        ceylonAtImportType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Import");
        ceylonAtModuleType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Module");
        ceylonAtPackageType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Package");
        ceylonAtNameType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Name");
        ceylonAtEnumeratedType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Enumerated");
        ceylonAtFinalType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Final");
        ceylonAtSequencedType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Sequenced");
        ceylonAtDefaultedType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Defaulted");
        ceylonAtTypeInfoType = enterClass("org.eclipse.ceylon.compiler.java.metadata.TypeInfo");
        ceylonAtNullableType = enterClass("org.eclipse.ceylon.common.Nullable");
        ceylonAtNonNullType = enterClass("org.eclipse.ceylon.common.NonNull");
        ceylonAtAttributeType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Attribute");
        ceylonAtMethodType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Method");
        ceylonAtFunctionalParameterType = enterClass("org.eclipse.ceylon.compiler.java.metadata.FunctionalParameter");
        ceylonAtObjectType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Object");
        ceylonAtClassType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Class");
        ceylonAtSatisfiedTypes = enterClass("org.eclipse.ceylon.compiler.java.metadata.SatisfiedTypes");
        ceylonAtCaseTypes = enterClass("org.eclipse.ceylon.compiler.java.metadata.CaseTypes");
        ceylonAtIgnore = enterClass("org.eclipse.ceylon.compiler.java.metadata.Ignore");
        ceylonAtConstructorName = enterClass("org.eclipse.ceylon.compiler.java.metadata.ConstructorName");
        ceylonAtJpa = enterClass("org.eclipse.ceylon.compiler.java.metadata.Jpa");
        ceylonVarianceType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Variance");
        ceylonAtTypeParameter = enterClass("org.eclipse.ceylon.compiler.java.metadata.TypeParameter");
        ceylonAtTypeParameters = enterClass("org.eclipse.ceylon.compiler.java.metadata.TypeParameters");
        ceylonAtAnnotationsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Annotations");
        ceylonAtAnnotationType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Annotation");
        ceylonAtAnnotationInstantiationType = enterClass("org.eclipse.ceylon.compiler.java.metadata.AnnotationInstantiation");
        ceylonAtAnnotationInstantiationTreeType = enterClass("org.eclipse.ceylon.compiler.java.metadata.AnnotationInstantiationTree");
        ceylonAtDeclarationReferenceType  = enterClass("org.eclipse.ceylon.compiler.java.metadata.DeclarationReference");
        ceylonAtEnumerationReferenceType  = enterClass("org.eclipse.ceylon.compiler.java.metadata.EnumerationReference");
        ceylonAtContainerType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Container");
        ceylonAtLocalContainerType = enterClass("org.eclipse.ceylon.compiler.java.metadata.LocalContainer");
        ceylonAtLocalDeclarationType = enterClass("org.eclipse.ceylon.compiler.java.metadata.LocalDeclaration");
        ceylonAtLocalDeclarationsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.LocalDeclarations");
        ceylonAtMemberType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Member");
        ceylonAtMembersType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Members");
        ceylonAtNamedArgumentType = enterClass("org.eclipse.ceylon.compiler.java.metadata.NamedArgument");
        ceylonAtValueTypeType = enterClass("org.eclipse.ceylon.compiler.java.metadata.ValueType");
        ceylonAtAliasType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Alias");
        ceylonAtTypeAliasType = enterClass("org.eclipse.ceylon.compiler.java.metadata.TypeAlias");
        ceylonAtTransientType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Transient");
        ceylonAtCompileTimeErrorType = enterClass("org.eclipse.ceylon.compiler.java.metadata.CompileTimeError");
        ceylonAtSetterType = enterClass("org.eclipse.ceylon.compiler.java.metadata.Setter");
        
        ceylonAtBooleanValueType = enterClass("org.eclipse.ceylon.compiler.java.metadata.BooleanValue");
        ceylonAtBooleanExprsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.BooleanExprs");
        ceylonAtCharacterValueType = enterClass("org.eclipse.ceylon.compiler.java.metadata.CharacterValue");
        ceylonAtCharacterExprsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.CharacterExprs");
        ceylonAtDeclarationValueType = enterClass("org.eclipse.ceylon.compiler.java.metadata.DeclarationValue");
        ceylonAtDeclarationExprsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.DeclarationExprs");
        ceylonAtFloatValueType = enterClass("org.eclipse.ceylon.compiler.java.metadata.FloatValue");
        ceylonAtFloatExprsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.FloatExprs");
        ceylonAtIntegerValueType = enterClass("org.eclipse.ceylon.compiler.java.metadata.IntegerValue");
        ceylonAtIntegerExprsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.IntegerExprs");
        ceylonAtObjectValueType = enterClass("org.eclipse.ceylon.compiler.java.metadata.ObjectValue");
        ceylonAtObjectExprsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.ObjectExprs");
        ceylonAtStringValueType = enterClass("org.eclipse.ceylon.compiler.java.metadata.StringValue");
        ceylonAtStringExprsType = enterClass("org.eclipse.ceylon.compiler.java.metadata.StringExprs");
        ceylonAtParameterValueType = enterClass("org.eclipse.ceylon.compiler.java.metadata.ParameterValue");
        
        ceylonUtilType = enterClass("org.eclipse.ceylon.compiler.java.Util");
        ceylonMetamodelType = enterClass("org.eclipse.ceylon.compiler.java.runtime.metamodel.Metamodel");
        ceylonTypeDescriptorType = enterClass("org.eclipse.ceylon.compiler.java.runtime.model.TypeDescriptor");
        ceylonReifiedTypeType = enterClass("org.eclipse.ceylon.compiler.java.runtime.model.ReifiedType");
        ceylonSerializationType = enterClass("org.eclipse.ceylon.compiler.java.runtime.serialization.$Serialization$");
        ceylonSerializableType = enterClass("org.eclipse.ceylon.compiler.java.runtime.serialization.Serializable");
        ...
        ceylonAtNoInitCheckType = enterClass("org.eclipse.ceylon.compiler.java.metadata.NoInitCheck");
        ceylonAtNeedsVoidBridgeType = enterClass("org.eclipse.ceylon.compiler.java.metadata.NeedsVoidBridge");
    ...
    public void loadCeylonSymbols() {
        ...
        ceylonArrayIterableType = enterClass("org.eclipse.ceylon.compiler.java.language.ArrayIterable");
        ceylonAbstractIterableType = enterClass("org.eclipse.ceylon.compiler.java.language.AbstractIterable");
        ceylonAbstractIteratorType = enterClass("org.eclipse.ceylon.compiler.java.language.AbstractIterator");
        ceylonConstantIterableType = enterClass("org.eclipse.ceylon.compiler.java.language.ConstantIterable");
        ceylonLazyIterableType = enterClass("org.eclipse.ceylon.compiler.java.language.LazyIterable");
        ceylonLazyInvokingIterableType = enterClass("org.eclipse.ceylon.compiler.java.language.LazyInvokingIterable");
        ...
        ceylonEnumeratedTypeErrorType = enterClass("org.eclipse.ceylon.compiler.java.language.EnumeratedTypeError");
        ceylonUninvokableErrorType = enterClass("org.eclipse.ceylon.compiler.java.language.UninvokableError");
        ceylonUninitializedMethodErrorType = enterClass("org.eclipse.ceylon.compiler.java.language.UninitializedMethodError");
        ceylonUnresolvedCompilationErrorType = enterClass("org.eclipse.ceylon.compiler.java.language.UnresolvedCompilationError");
        ceylonAbstractCallableType = enterClass("org.eclipse.ceylon.compiler.java.language.AbstractCallable");
        ceylonAbstractTypeConstructorType = enterClass("org.eclipse.ceylon.compiler.java.language.AbstractTypeConstructor");
        ceylonSerializationProxyType = enterClass("org.eclipse.ceylon.compiler.java.language.SerializationProxy");
        ceylonVariableBoxType = enterClass("org.eclipse.ceylon.compiler.java.language.VariableBox");
        ceylonVariableBoxLongType = enterClass("org.eclipse.ceylon.compiler.java.language.VariableBoxLong");
        ceylonVariableBoxIntType = enterClass("org.eclipse.ceylon.compiler.java.language.VariableBoxInt");
        ceylonVariableBoxDoubleType = enterClass("org.eclipse.ceylon.compiler.java.language.VariableBoxDouble");
        ceylonVariableBoxByteType = enterClass("org.eclipse.ceylon.compiler.java.language.VariableBoxByte");
        ceylonVariableBoxBooleanType = enterClass("org.eclipse.ceylon.compiler.java.language.VariableBoxBoolean");
        ceylonGetterType = enterClass("org.eclipse.ceylon.compiler.java.language.Getter");
        ceylonGetterLongType = enterClass("org.eclipse.ceylon.compiler.java.language.GetterLong");
        ceylonGetterIntType = enterClass("org.eclipse.ceylon.compiler.java.language.GetterInt");
        ceylonGetterDoubleType = enterClass("org.eclipse.ceylon.compiler.java.language.GetterDouble");
        ceylonGetterFloatType = enterClass("org.eclipse.ceylon.compiler.java.language.GetterFloat");
        ceylonGetterByteType = enterClass("org.eclipse.ceylon.compiler.java.language.GetterByte");
        ceylonGetterBooleanType = enterClass("org.eclipse.ceylon.compiler.java.language.GetterBoolean");
        ceylonGetterCharType = enterClass("org.eclipse.ceylon.compiler.java.language.GetterChar");
    }
}
