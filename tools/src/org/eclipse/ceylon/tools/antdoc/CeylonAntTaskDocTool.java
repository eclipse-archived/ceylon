 ...
 ********************************************************************************/
package org.eclipse.ceylon.tools.antdoc;
...
import org.eclipse.ceylon.common.tools.help.DocBuilder;
...
public class CeylonAntTaskDocTool extends CeylonBaseTool {
    ...
    public CeylonAntTaskDocTool() {
        ...
        try {
            ...
            OPTION_EQUIV_ANNOTATION = (Class<? extends Annotation>)Class.forName("org.eclipse.ceylon.ant.OptionEquivalent", false, loader);
            REQUIRED_ANNOTATION  = (Class<? extends Annotation>)Class.forName("org.eclipse.ceylon.ant.Required", false, loader);
            TOOL_EQUIV_ANNOTATION  = (Class<? extends Annotation>)Class.forName("org.eclipse.ceylon.ant.ToolEquivalent", false, loader);
            DOC_ANNOTATION  = (Class<? extends Annotation>)Class.forName("org.eclipse.ceylon.ant.AntDoc", false, loader);
            IGNORE_ANNOTATION = (Class<? extends Annotation>)Class.forName("org.eclipse.ceylon.ant.AntDocIgnore", false, loader);
            ATTRIBUTE_ANNOTATION = (Class<? extends Annotation>)Class.forName("org.eclipse.ceylon.ant.AntAttribute", false, loader);
    ...
    public void run() throws Exception {
        for (Class<?> t : Arrays.asList(
                Class.forName("org.eclipse.ceylon.ant.CeylonCompileAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonCompileJsAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonRunAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonRunJsAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonTestAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonTestJsAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonDocAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonWarAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonImportJarAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonCopyAntTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonModuleDescriptorTask", false, loader),
                Class.forName("org.eclipse.ceylon.ant.CeylonPluginAntTask", false, loader)
                )) {
