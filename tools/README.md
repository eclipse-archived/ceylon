...
* `src`       - the Ceylon cli tools module sources
* `test-src`  - the Ceylon cli tools module unit tests
...
Once built, the module lives in this jar:
    ...
    ~/.ceylon/repo/org/eclipse/ceylon/tools/0.2/org.eclipse.ceylon.tools-0.2.jar
