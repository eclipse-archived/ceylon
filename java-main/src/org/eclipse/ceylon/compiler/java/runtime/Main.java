...
import org.eclipse.ceylon.cmr.impl.BytecodeUtils;
import org.eclipse.ceylon.cmr.impl.Configuration;
import org.eclipse.ceylon.cmr.impl.MavenRepository;
import org.eclipse.ceylon.cmr.impl.OSGiDependencyResolver;
import org.eclipse.ceylon.cmr.impl.PropertiesDependencyResolver;
import org.eclipse.ceylon.cmr.impl.XmlDependencyResolver;
import org.eclipse.ceylon.cmr.maven.MavenBackupDependencyResolver;
...
import org.eclipse.ceylon.model.loader.Java9ModuleReader;
import org.eclipse.ceylon.model.loader.NamingBase;
import org.eclipse.ceylon.model.loader.OsgiUtil;
import org.eclipse.ceylon.model.loader.Java9ModuleReader.Java9Module;
...
//                String label = (String)moduleLabel;
    ...
    private void registerInMetamodel(String name, String version, boolean optional) {
        ...
        } catch (org.eclipse.ceylon.compiler.java.runtime.Main.ClassPath.ModuleNotFoundException e) {
            if(optional)
                return;
            throw new RuntimeException(e);
        }
