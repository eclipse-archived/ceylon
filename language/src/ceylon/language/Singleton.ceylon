...
shared class Singleton<out Element>(Element element)
    ...
    doc "Returns `0`."
    shared actual transient Integer lastIndex = 0;
    
    doc "Returns `1`."
    shared actual transient Integer size = 1;
    
    doc "Returns the element contained in this `Singleton`."
    shared actual transient Element first = element;
    
    doc "Returns the element contained in this `Singleton`."
    shared actual transient Element last = element;
    
    doc "Returns `Empty`."
    shared actual transient Empty rest = {};
    ...
    shared actual transient Singleton<Element> clone = this;
    ...
    shared actual transient Singleton<Element> reversed = this;
    ...
    shared actual transient Integer hash = 1;
    ...
    shared actual transient Singleton<Element> coalesced = this;
