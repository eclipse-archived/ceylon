...
public class PrimitiveArrayIterableTest {
    ...
    public void testIntArrayIterable() {
        ...
        ceylon.language.Iterable<? extends ceylon.language.Integer,? extends java.lang.Object> zero50 = IntArray.getIterable(new int[50]);
        ceylon.language.Iterable<? extends ceylon.language.Integer,? extends java.lang.Object> zero_seven2 = zero50.take(8);
        Assert.assertEquals("[0, 0, 0, 0, 0, 0, 0, 0]", zero_seven2.sequence().toString());
