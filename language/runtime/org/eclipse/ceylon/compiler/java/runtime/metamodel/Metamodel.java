...
import org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.OpenTypeVariableImpl;
...
import org.eclipse.ceylon.compiler.java.runtime.metamodel.meta.InterfaceImpl;
...
import org.eclipse.ceylon.model.runtime.CeylonModuleClassLoader.ModuleLoadException;
...
public class Metamodel {
    ...
    private static Map<org.eclipse.ceylon.model.typechecker.model.Package, org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.PackageImpl> typeCheckPackagesToRuntimeModel
        = new HashMap<org.eclipse.ceylon.model.typechecker.model.Package, org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.PackageImpl>();

    private static Map<org.eclipse.ceylon.model.typechecker.model.Module, org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ModuleImpl> typeCheckModulesToRuntimeModel
        = new HashMap<org.eclipse.ceylon.model.typechecker.model.Module, org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ModuleImpl>();
...
//            throw new ReifiedTypeError("Cannot determine whether " + instance.getClass() + " is a " + type);
            ...
            if(ret == null){
                ...
                if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.Class){
                    ...
                    ret = klass.hasConstructors() || klass.hasEnumerated() || klass.isAnonymous()?
                            new org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ClassWithConstructorsDeclarationImpl(klass) :
                            new org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ClassWithInitializerDeclarationImpl(klass);
                    ...
                    if (method.getTypeDeclaration() instanceof org.eclipse.ceylon.model.typechecker.model.Constructor) {
                        ret = new CallableConstructorDeclarationImpl(method, 
                                (org.eclipse.ceylon.model.typechecker.model.Constructor)method.getTypeDeclaration());
                    } else {
                    ...
                    if (value.getTypeDeclaration() instanceof org.eclipse.ceylon.model.typechecker.model.Constructor) {
                        ret = new ValueConstructorDeclarationImpl(value, 
                                (org.eclipse.ceylon.model.typechecker.model.Constructor)value.getTypeDeclaration());
                    } else {
    ...
    public static boolean hasTypeParameters(org.eclipse.ceylon.model.typechecker.model.TypedDeclaration model) {
        if(model instanceof org.eclipse.ceylon.model.typechecker.model.Generic)
            return hasTypeParameters((org.eclipse.ceylon.model.typechecker.model.Generic)model);
        if(model.getContainer() instanceof org.eclipse.ceylon.model.typechecker.model.ClassOrInterface)
            return hasTypeParameters((org.eclipse.ceylon.model.typechecker.model.ClassOrInterface)model.getContainer());
        return false;
    }
    
    public static boolean hasTypeParameters(org.eclipse.ceylon.model.typechecker.model.Generic model) {
        if(!model.getTypeParameters().isEmpty())
            return true;
        Object container = ((org.eclipse.ceylon.model.typechecker.model.Declaration)model).getContainer();
        if(container instanceof org.eclipse.ceylon.model.typechecker.model.ClassOrInterface)
            return hasTypeParameters((org.eclipse.ceylon.model.typechecker.model.ClassOrInterface) container);
        return false;
    }

    public static org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.PackageImpl getOrCreateMetamodel(org.eclipse.ceylon.model.typechecker.model.Package declaration){
        synchronized(getLock()){
            org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.PackageImpl ret = typeCheckPackagesToRuntimeModel.get(declaration);
            if(ret == null){
                // make sure its module is loaded
                org.eclipse.ceylon.model.typechecker.model.Module mod = declaration.getModule();
                getOrCreateMetamodel(mod);

                ret = new org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.PackageImpl(declaration); 
    ...
    public static org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ModuleImpl getOrCreateMetamodel(
            org.eclipse.ceylon.model.typechecker.model.Module declaration){
        return getOrCreateMetamodel(null, declaration, null, false /* not optional */);
    }

    private static org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ModuleImpl getOrCreateMetamodel(
            String namespace,
            org.eclipse.ceylon.model.typechecker.model.Module declaration,
            Set<org.eclipse.ceylon.model.typechecker.model.Module> visitedModules, boolean optional){
        synchronized(getLock()){
            org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ModuleImpl ret = typeCheckModulesToRuntimeModel.get(declaration);
            if(ret == null){
                // make sure it is loaded
                loadModule(namespace, declaration, visitedModules, optional);
                if(!declaration.isAvailable())
                    return null;
                ret = new org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ModuleImpl(declaration); 
    ...
    public static ceylon.language.meta.declaration.OpenType getMetamodel(Type pt) {
        ...
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.Class){
            return new org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.OpenClassTypeImpl(pt);
        }
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.Constructor){
            return new org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.OpenClassTypeImpl(pt.getQualifyingType());
        }
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.Interface){
            return new org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.OpenInterfaceTypeImpl(pt);
        }
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.TypeParameter){
            org.eclipse.ceylon.model.typechecker.model.TypeParameter tp = (org.eclipse.ceylon.model.typechecker.model.TypeParameter) declaration;
            return new OpenTypeVariableImpl(tp);
        }
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.UnionType){
            return new OpenUnionTypeImpl((org.eclipse.ceylon.model.typechecker.model.UnionType)declaration);
        }
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.IntersectionType){
            return new OpenIntersectionTypeImpl((org.eclipse.ceylon.model.typechecker.model.IntersectionType)declaration);
        }
        ...
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.UnknownType){
            ((org.eclipse.ceylon.model.typechecker.model.UnknownType)declaration).reportErrors();
        }
        throw Metamodel.newModelError("Declaration type not supported yet: "+declaration);
    }
    ...
    public static ClassLoader getClassLoader(org.eclipse.ceylon.model.typechecker.model.Module module) {
        if (JDKUtils.isJDKModule(module.getNameAsString())
            ...
            for (org.eclipse.ceylon.model.typechecker.model.Package p: module.getPackages()) {
                for (Declaration d: p.getMembers()) {
                    if (d instanceof org.eclipse.ceylon.model.typechecker.model.ClassOrInterface) {
    ...
    private static ReflectionClass classMirror(org.eclipse.ceylon.model.typechecker.model.Module module,
            String className) {
    ...
    public static java.lang.Class<?> getJavaClass(org.eclipse.ceylon.model.typechecker.model.Declaration declaration) {
        ...
        if(declaration.getContainer() instanceof org.eclipse.ceylon.model.typechecker.model.Declaration){
            return getJavaClass((org.eclipse.ceylon.model.typechecker.model.Declaration)declaration.getContainer());
        }
        throw Metamodel.newModelError("Unsupported declaration type: " + declaration + " of type "+declaration.getClass());
    }
    
    public static java.lang.reflect.Constructor<?> getJavaConstructor(org.eclipse.ceylon.model.typechecker.model.Constructor declaration) {
        return getJavaConstructor((org.eclipse.ceylon.model.typechecker.model.Class)declaration.getContainer(), declaration.getName());
    }
    
    public static java.lang.reflect.Constructor<?> getJavaConstructor(org.eclipse.ceylon.model.typechecker.model.Class clazz, String ctorName) {
    ...
    public static java.lang.reflect.Method getJavaInstantiator(org.eclipse.ceylon.model.typechecker.model.Constructor declaration, String methodName) {
        org.eclipse.ceylon.model.typechecker.model.Class cls = (org.eclipse.ceylon.model.typechecker.model.Class)declaration.getContainer();
    ...
    public static List<java.lang.reflect.Constructor<?>> getJavaConstructors(
            org.eclipse.ceylon.model.typechecker.model.Constructor declaration) {
...
//        java.lang.reflect.Method[] ctors = outerJavaClass.getDeclaredMethods();
    ...
    public static boolean isDefaultConstructor(org.eclipse.ceylon.model.typechecker.model.Constructor declaration) {
        return declaration.getName() == null || declaration.getName().isEmpty();
    }

    public static java.lang.reflect.AnnotatedElement getJavaAnnotatedElement(org.eclipse.ceylon.model.typechecker.model.Function declaration) {
    ...
    public static java.lang.reflect.Method getJavaMethod(org.eclipse.ceylon.model.typechecker.model.Function declaration) {
    ...
    public static org.eclipse.ceylon.model.typechecker.model.Type getModel(ceylon.language.meta.declaration.OpenType pt) {
    ...
    public static org.eclipse.ceylon.model.typechecker.model.Type getModel(ceylon.language.meta.model.Type<?> pt) {
    ...
    public static org.eclipse.ceylon.model.typechecker.model.Package getPackage(org.eclipse.ceylon.model.typechecker.model.Declaration declaration) {
        Scope scope = declaration.getContainer();
        while(scope != null && scope instanceof org.eclipse.ceylon.model.typechecker.model.Package == false)
            scope = scope.getContainer();
        if(scope == null)
            throw Metamodel.newModelError("Declaration with no package: "+declaration);
        return (org.eclipse.ceylon.model.typechecker.model.Package)scope;
    }


    public static java.util.List<org.eclipse.ceylon.model.typechecker.model.Type> getProducedTypes(Sequential<? extends ceylon.language.meta.model.Type<?>> types) {
        Iterator<?> iterator = types.iterator();
        Object it;
        List<org.eclipse.ceylon.model.typechecker.model.Type> producedTypes = new LinkedList<org.eclipse.ceylon.model.typechecker.model.Type>();
        while((it = iterator.next()) != finished_.get_()){
            ceylon.language.meta.model.Type<?> pt = (ceylon.language.meta.model.Type<?>) it;
            org.eclipse.ceylon.model.typechecker.model.Type modelPt = Metamodel.getModel(pt);
    ...
    private static void addProxyCeylonAnnotation(
        ...
        if(jAnnotationType.getName().startsWith("org.eclipse.ceylon.compiler.java.metadata.")
                || jAnnotationType.getName().startsWith("org.eclipse.ceylon.common."))
            return;
        // seriously, wtf?
    ...
    public static ceylon.language.meta.declaration.Module findLoadedModule(String name, String version) {
        // FIXME: this probably needs synchronisation to avoid new modules loaded during traversal
        org.eclipse.ceylon.model.typechecker.model.Module module = moduleManager.findLoadedModule(name, version);
        if(module == null && !moduleManager.isManualMetamodelSetup()){
            org.eclipse.ceylon.model.typechecker.model.Module newModule = moduleManager.getOrCreateModule(ModuleManager.splitModuleName(name), version);
    ...
    public static Module getDefaultModule() {
        org.eclipse.ceylon.model.typechecker.model.Module module = moduleManager.getModules().getDefaultModule();
        // consider it optional to get null rather than exception
        return module != null ? getOrCreateMetamodel(null, module, null, true) : null;
    }
    ...
    public static boolean isCeylon(org.eclipse.ceylon.model.typechecker.model.ClassOrInterface declaration){
        return ModelUtil.isCeylonDeclaration(declaration);
    }

    public static TypeDescriptor getTypeDescriptorForArguments(org.eclipse.ceylon.model.typechecker.model.Unit unit, 
            org.eclipse.ceylon.model.typechecker.model.Functional decl, 
        ...
        if(!decl.getParameterLists().isEmpty()){
            ...
            org.eclipse.ceylon.model.typechecker.model.Type tupleType 
    ...
    public static Type getProducedTypeForArguments(org.eclipse.ceylon.model.typechecker.model.Unit unit, 
            org.eclipse.ceylon.model.typechecker.model.Functional decl, 
            Reference producedReference) {
    ...
    public static ceylon.language.meta.declaration.NestableDeclaration getOrCreateMetamodel(java.lang.Class<?> klass){
        synchronized(getLock()){
            ...
            if (result == null) {
                ...
                org.eclipse.ceylon.model.typechecker.model.Module module = moduleManager.findModuleForClass(klass);
                org.eclipse.ceylon.model.typechecker.model.TypeDeclaration decl = 
    ...
    public static org.eclipse.ceylon.model.typechecker.model.Parameter getParameterFromTypedDeclaration(org.eclipse.ceylon.model.typechecker.model.TypedDeclaration declaration) {
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.FunctionOrValue)
            return ((org.eclipse.ceylon.model.typechecker.model.FunctionOrValue) declaration).getInitializerParameter();
        return null;
    }
    ...
    public static Sequential<? extends ceylon.language.meta.declaration.TypeParameter> getTypeParameters(org.eclipse.ceylon.model.typechecker.model.Generic declaration) {
        List<org.eclipse.ceylon.model.typechecker.model.TypeParameter> typeParameters = declaration.getTypeParameters();
    ...
    public static AnnotatedDeclaration getContainer(Declaration declaration) {
        ...
        if(container instanceof org.eclipse.ceylon.model.typechecker.model.Declaration)
            return Metamodel.getOrCreateMetamodel((org.eclipse.ceylon.model.typechecker.model.Declaration)container);
        if(container instanceof org.eclipse.ceylon.model.typechecker.model.Package)
            return Metamodel.getOrCreateMetamodel((org.eclipse.ceylon.model.typechecker.model.Package)container);
        // FIXME: can that happen?
        throw Metamodel.newModelError("Illegal container type: "+container);
    }

    public static boolean isLocalType(org.eclipse.ceylon.model.typechecker.model.TypeDeclaration decl) {
    ...
    public static ceylon.language.Map<? extends ceylon.language.meta.declaration.TypeParameter, ? extends ceylon.language.Sequence<? extends Object>> 
        ...
        java.util.Map<org.eclipse.ceylon.model.typechecker.model.TypeParameter, org.eclipse.ceylon.model.typechecker.model.Type> ptArguments 
            = appliedFunction.getTypeArguments();
        Map<TypeParameter, SiteVariance> varianceOverrides = appliedFunction instanceof org.eclipse.ceylon.model.typechecker.model.Type
                ? ((org.eclipse.ceylon.model.typechecker.model.Type)appliedFunction).getVarianceOverrides() : null;
        while((it = typeParameters.next()) != finished_.get_()){
            org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.TypeParameterImpl tp = (org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.TypeParameterImpl) it;
            org.eclipse.ceylon.model.typechecker.model.TypeParameter tpDecl = (org.eclipse.ceylon.model.typechecker.model.TypeParameter) tp.declaration;
            org.eclipse.ceylon.model.typechecker.model.Type ptArg = ptArguments.get(tpDecl);
    ...
    public static ceylon.language.meta.model.Type<?> union(
        ...
        Type unionType = org.eclipse.ceylon.model.typechecker.model.ModelUtil.unionType(x, y, moduleManager.getModelLoader().getUnit());
    ...
    public static ceylon.language.meta.model.Type<?> intersection(
        ...
        Type x = Metamodel.getModel(typeX);
        Type y = Metamodel.getModel(typeY);
        Type intersectionType = org.eclipse.ceylon.model.typechecker.model.ModelUtil.intersectionType(x, y, moduleManager.getModelLoader().getUnit());
    ...
    public static <Return> Return namedApply(Callable<? extends Return> function,
            ...
            org.eclipse.ceylon.model.typechecker.model.Functional declaration,
    ...
    public static Object getCompanionInstance(java.lang.Object instance, org.eclipse.ceylon.model.typechecker.model.Interface iface) {
        if (instance == null) {
            return null;
        }
        try {
    ...
    public static <Type> Sequential getConstructors(
            ClassOrInterfaceImpl<Type> cls,
            boolean justShared,
    ...
    private static java.lang.Class<?> getJavaClass(Type pt) {
        TypeDeclaration declaration = pt.getDeclaration();
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.ClassOrInterface){
