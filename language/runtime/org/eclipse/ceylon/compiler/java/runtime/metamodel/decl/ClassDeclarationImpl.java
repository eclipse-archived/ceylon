...
public abstract class ClassDeclarationImpl 
    ...
    public ClassDeclarationImpl(org.eclipse.ceylon.model.typechecker.model.Class declaration) {
        super(declaration);
    }
...
//                }
    ...
    public boolean getAbstract() {
        return ((org.eclipse.ceylon.model.typechecker.model.Class)declaration).isAbstract();
    }
    
    @Override
    public boolean getSerializable() {
        return ((org.eclipse.ceylon.model.typechecker.model.Class)declaration).isSerializable();
    }

    @Override
    public boolean getFinal() {
        return ((org.eclipse.ceylon.model.typechecker.model.Class)declaration).isFinal();
    }
    ...
    <Type, Arguments extends Sequential<? extends Object>> ceylon.language.meta.model.Class<Type, Arguments> classApplyInternal(@Ignore TypeDescriptor $reifiedType,
            ...
            org.eclipse.ceylon.model.typechecker.model.Reference appliedType){
        if(!getToplevel()) {
            String msg;
            if (getStatic()) {
                msg = "Cannot apply a static declaration with no container type: use staticApply";
