...
public class CallableConstructorDeclarationImpl
    ...
    public CallableConstructorDeclarationImpl(org.eclipse.ceylon.model.typechecker.model.Functional function, Constructor constructor) {
        super((org.eclipse.ceylon.model.typechecker.model.Declaration)function);
        List<org.eclipse.ceylon.model.typechecker.model.TypeParameter> typeParameters = ((Generic) constructor.getContainer()).getTypeParameters();
