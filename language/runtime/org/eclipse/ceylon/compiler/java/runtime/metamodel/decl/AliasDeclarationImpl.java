...
public class AliasDeclarationImpl extends NestableDeclarationImpl 
    ...
    public AliasDeclarationImpl(org.eclipse.ceylon.model.typechecker.model.TypeAlias declaration) {
        super(declaration);
    ...
    private void init() {
        org.eclipse.ceylon.model.typechecker.model.TypeAlias declaration = (org.eclipse.ceylon.model.typechecker.model.TypeAlias) this.declaration;
    ...
    public <Type extends Object> ceylon.language.meta.model.Type<Type> apply(@Ignore TypeDescriptor $reifiedType,
        ...
        List<org.eclipse.ceylon.compiler.typechecker.model.Type> producedTypes = Metamodel.getProducedTypes(typeArguments);
