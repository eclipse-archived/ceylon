...
public class FunctionImpl<Type, Arguments extends Sequential<? extends Object>> 
    ...
    public FunctionImpl(@Ignore TypeDescriptor $reifiedType, 
        ...
        org.eclipse.ceylon.model.typechecker.model.Functional decl = (org.eclipse.ceylon.model.typechecker.model.Functional) function.declaration;
        ...
        String name = Metamodel.getJavaMethodName((org.eclipse.ceylon.model.typechecker.model.Functional) function.declaration);
        ...
        if(javaClass == ceylon.language.Object.class
            ...
            found = Metamodel.getJavaMethod((org.eclipse.ceylon.model.typechecker.model.Function) function.declaration);
    ...
    private MethodHandle reflectionToMethodHandle(Method foundMethod, java.lang.Class<?> javaClass, Object instance, 
        ...
        org.eclipse.ceylon.model.typechecker.model.Function functionModel = (org.eclipse.ceylon.model.typechecker.model.Function)appliedFunction.getDeclaration();
        ...
        if (functionModel.isStatic()) {
            reifiedTypeParameters = new ArrayList<org.eclipse.ceylon.model.typechecker.model.TypeParameter>();
    ...
    public Type namedApply(@Name("arguments")
        ...
        return Metamodel.namedApply(this, this, 
                (org.eclipse.ceylon.model.typechecker.model.Functional)declaration.declaration, 
