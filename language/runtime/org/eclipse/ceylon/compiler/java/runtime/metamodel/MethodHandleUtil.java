...
public class MethodHandleUtil {
    ...
    public static MethodHandle insertReifiedTypeArguments(MethodHandle constructor, int insertAt, List<org.eclipse.ceylon.model.typechecker.model.Type> typeArguments) {
    ...
    public static MethodHandle insertConstructorNameArgument(MethodHandle constructor, int insertAt, org.eclipse.ceylon.model.typechecker.model.Constructor ctor) {
    ...
    private static boolean isCeylonCharacter(Type producedType) {
        ...
        if(declaration instanceof org.eclipse.ceylon.model.typechecker.model.Class == false)
            return false;
