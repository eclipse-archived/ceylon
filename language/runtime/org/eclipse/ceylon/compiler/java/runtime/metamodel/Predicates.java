...
import org.eclipse.ceylon.compiler.java.language.EnumeratedTypeError;
...
public class Predicates {
    ...
    private static final Predicate<Declaration> DECLARATION_IS_VALUE = new Predicate<Declaration>() {  
        ...
        public boolean accept(Declaration declaration) {
            return declaration instanceof org.eclipse.ceylon.model.typechecker.model.Value
                    && !(((org.eclipse.ceylon.model.typechecker.model.Value)declaration).getTypeDeclaration() instanceof Constructor);
        }
        @Override
        public String toString() {
            return "(kind = Value)";
    ...
    private static final Predicate<Declaration> DECLARATION_IS_FUNCTION = new Predicate<Declaration>() {  
        @Override
        public boolean accept(Declaration declaration) {
            return declaration instanceof org.eclipse.ceylon.model.typechecker.model.Function
                    && !(((org.eclipse.ceylon.model.typechecker.model.Function)declaration).getTypeDeclaration() instanceof Constructor);
        }
        @Override
        public String toString() {
    ...
    private static final Predicate<Declaration> DECLARATION_IS_FUNCTION_OR_VALUE = new Predicate<Declaration>() {
        ...
        public boolean accept(Declaration declaration) {
            return (declaration instanceof org.eclipse.ceylon.model.typechecker.model.Value
                || declaration instanceof org.eclipse.ceylon.model.typechecker.model.Function)
                && !(((org.eclipse.ceylon.model.typechecker.model.FunctionOrValue)declaration).getTypeDeclaration() instanceof Constructor)
            ;
        }
        @Override
        public String toString() {
    ...
    private static final Predicate<Declaration> DECLARATION_IS_CLASS = new Predicate<Declaration>() {  
        @Override
        public boolean accept(Declaration declaration) {
            return declaration instanceof org.eclipse.ceylon.model.typechecker.model.Class;
        }
        @Override
        public String toString() {
            return "(kind = Class)";
    ...
    private static final Predicate<Declaration> DECLARATION_IS_CLASS_WITH_INIT = new Predicate<Declaration>() {  
        ...
        public boolean accept(Declaration declaration) {
            return declaration instanceof org.eclipse.ceylon.model.typechecker.model.Class
                    && !((org.eclipse.ceylon.model.typechecker.model.Class)declaration).hasConstructors();
        }
        @Override
        public String toString() {
    ...
    private static final Predicate<Declaration> DECLARATION_IS_CONSTRUCTOR = new Predicate<Declaration>() {  
        @Override
        public boolean accept(Declaration declaration) {
            return declaration instanceof org.eclipse.ceylon.model.typechecker.model.FunctionOrValue
                    && ((org.eclipse.ceylon.model.typechecker.model.FunctionOrValue)declaration).getTypeDeclaration() instanceof Constructor;
        }
        @Override
        public String toString() {
    ...
    private static final Predicate<Declaration> DECLARATION_IS_INTERFACE = new Predicate<Declaration>() {  
        @Override
        public boolean accept(Declaration declaration) {
            return declaration instanceof org.eclipse.ceylon.model.typechecker.model.Interface;
        }
        @Override
        public String toString() {
    ...
    private static final Predicate<Declaration> DECLARATION_IS_CLASS_OR_INTERFACE = new Predicate<Declaration>() {  
        @Override
        public boolean accept(Declaration declaration) {
            return declaration instanceof org.eclipse.ceylon.model.typechecker.model.ClassOrInterface;
        }
        @Override
        public String toString() {
    ...
    private static final Predicate<Declaration> DECLARATION_IS_ALIAS = new Predicate<Declaration>() {  
        @Override
        public boolean accept(Declaration declaration) {
            return declaration instanceof org.eclipse.ceylon.model.typechecker.model.TypeAlias;
        }
        @Override
        public String toString() {
            return "(kind = Alias)";
