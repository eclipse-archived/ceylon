...
public class MemberClassImpl<Container, Type, Arguments extends Sequential<? extends Object>> 
    ...
    protected void init() {
        ...
        if(!decl.isAnonymous() 
            ...
            java.util.List<org.eclipse.ceylon.model.typechecker.model.Type> parameterProducedTypes = Metamodel.getParameterProducedTypes(decl.getParameterList().getParameters(), producedType);
