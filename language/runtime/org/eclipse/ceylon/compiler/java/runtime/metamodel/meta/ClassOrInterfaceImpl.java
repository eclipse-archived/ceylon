...
public abstract class ClassOrInterfaceImpl<Type> 
    ...
    private static final List<org.eclipse.ceylon.model.typechecker.model.Type> NO_TYPE_ARGS = Collections.<org.eclipse.ceylon.model.typechecker.model.Type>emptyList();
    private volatile boolean initialised;
    public final org.eclipse.ceylon.model.typechecker.model.Type producedType;
    public final org.eclipse.ceylon.compiler.java.runtime.metamodel.decl.ClassOrInterfaceDeclarationImpl declaration;
    ...
    ClassOrInterfaceImpl(@Ignore TypeDescriptor $reifiedType, org.eclipse.ceylon.model.typechecker.model.Type producedType){
    ...
    private <Container> ClassOrInterfaceImpl<Container> getAppliedContainer(@Ignore TypeDescriptor $reifiedContainer, 
        ...
        if(valueContainer != declaration){
            org.eclipse.ceylon.model.typechecker.model.Type valueContainerType = this.producedType.getSupertype((org.eclipse.ceylon.model.typechecker.model.TypeDeclaration)valueContainer.declaration);
    ...
    private <Container,Get,Set> void addAttributeIfCompatible(@Ignore TypeDescriptor $reifiedContainer,
            ...
            @Ignore TypeDescriptor $reifiedSet,
            ArrayList<ceylon.language.meta.model.Attribute<? super Container,? extends Get,? super Set>> members,
            ValueDeclarationImpl decl, org.eclipse.ceylon.model.typechecker.model.Type qualifyingType, 
            ceylon.language.meta.model.Type<Container> qualifyingMetamodel,
            org.eclipse.ceylon.model.typechecker.model.Type reifiedGet, 
            org.eclipse.ceylon.model.typechecker.model.Type reifiedSet){
        // now the types
    ...
    private <Container,Type,Arguments extends Sequential<? extends Object>> void addMethodIfCompatible(@Ignore TypeDescriptor $reifiedContainer,
            ...
            @Ignore TypeDescriptor $reifiedArguments,
            ArrayList<ceylon.language.meta.model.Method<? super Container,? extends Type,? super Arguments>> members,
            FunctionDeclarationImpl decl, org.eclipse.ceylon.model.typechecker.model.Type qualifyingType, 
            ClassOrInterfaceImpl<Container> containerMetamodel,
            org.eclipse.ceylon.model.typechecker.model.Type reifiedType, 
            org.eclipse.ceylon.model.typechecker.model.Type reifiedArguments){
        // now the types
    ...
    private <Container,Type,Arguments extends Sequential<? extends Object>> void addClassIfCompatible(@Ignore TypeDescriptor $reifiedContainer,
            ...
            @Ignore TypeDescriptor $reifiedArguments,
            ArrayList<ceylon.language.meta.model.MemberClass<? super Container,? extends Type,? super Arguments>> members,
            ClassDeclarationImpl decl, org.eclipse.ceylon.model.typechecker.model.Type qualifyingType, 
            ClassOrInterfaceImpl<Container> containerMetamodel,
            org.eclipse.ceylon.model.typechecker.model.Type reifiedType, 
            org.eclipse.ceylon.model.typechecker.model.Type reifiedArguments){
        // now the types
    ...
    private <Container,Type> void addInterfaceIfCompatible(@Ignore TypeDescriptor $reifiedContainer,
            @Ignore TypeDescriptor $reifiedType,
            ArrayList<ceylon.language.meta.model.MemberInterface<? super Container,? extends Type>> members,
            InterfaceDeclarationImpl decl, org.eclipse.ceylon.model.typechecker.model.Type qualifyingType, 
            ClassOrInterfaceImpl<Container> containerMetamodel,
            org.eclipse.ceylon.model.typechecker.model.Type reifiedType){
        // now the types
        Reference producedReference = decl.declaration.appliedReference(qualifyingType, Collections.<org.eclipse.ceylon.model.typechecker.model.Type>emptyList());
    ...
    static class MemberLookup<T, Container>{
        ...
        public final org.eclipse.ceylon.model.typechecker.model.Type qualifyingType;
    ...
    private <T extends NestableDeclarationImpl, Container> MemberLookup<T, Container> lookupMember(@Ignore TypeDescriptor $reifiedT,
            @Ignore TypeDescriptor $reifiedContainer,
            org.eclipse.ceylon.model.typechecker.model.Type reifiedContainer,
            T value) {
        ClassOrInterfaceImpl<Container> containerMetamodel;
        org.eclipse.ceylon.model.typechecker.model.Type qualifyingType;
