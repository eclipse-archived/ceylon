...
public final class FloatArray implements ReifiedType {
    ...
    @org.eclipse.ceylon.common.NonNull
    @TypeInfo("org.eclipse.ceylon.compiler.java.language::FloatArray")
    @org.eclipse.ceylon.compiler.java.metadata.Name("from")
    public static final FloatArray from(@org.eclipse.ceylon.common.NonNull
            @Name("array")
            @TypeInfo("ceylon.language::Array<java.lang::Float>")
            final ceylon.language.Array<? extends java.lang.Float> array$param$) {
        throw Util.makeJavaArrayWrapperException();
    } 
