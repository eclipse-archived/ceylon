...
public final class CharArray implements ReifiedType {
    ...
    @org.eclipse.ceylon.common.NonNull
    @TypeInfo("org.eclipse.ceylon.compiler.java.language::CharArray")
    @org.eclipse.ceylon.compiler.java.metadata.Name("from")
    public static final CharArray from(@org.eclipse.ceylon.common.NonNull
            @Name("array")
...
extends BaseIterable<ceylon.language.Character, ceylon.language.Null> {
    ...
    public ceylon.language.Character getFirst() {
        return getEmpty() ? null : ceylon.language.Character.instance(this.array[this.start]);
    }
    
    
    @Override
    public ceylon.language.Character getLast() {
        return getEmpty() ? null : ceylon.language.Character.instance(this.array[this.end-1]);
    }
