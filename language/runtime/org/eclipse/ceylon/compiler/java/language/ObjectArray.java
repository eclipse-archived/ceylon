...
public final class ObjectArray<T> implements ReifiedType {
    ...
    @org.eclipse.ceylon.common.NonNull
    @org.eclipse.ceylon.compiler.java.metadata.TypeInfo("org.eclipse.ceylon.compiler.java.language::ObjectArray<T>")
    public static final <T>ObjectArray<T> from(
            @org.eclipse.ceylon.compiler.java.metadata.Ignore
            final TypeDescriptor $reified$T, 
            @org.eclipse.ceylon.compiler.java.metadata.Name("array")
            @org.eclipse.ceylon.common.NonNull
            @org.eclipse.ceylon.compiler.java.metadata.TypeInfo("ceylon.language::Array<T?>")
