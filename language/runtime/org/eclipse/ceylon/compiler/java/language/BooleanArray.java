...
public final class BooleanArray implements ReifiedType {
    ...
    @org.eclipse.ceylon.common.NonNull
    @TypeInfo("org.eclipse.ceylon.compiler.java.language::BooleanArray")
    @org.eclipse.ceylon.compiler.java.metadata.Name("from")
    public static final BooleanArray from(@org.eclipse.ceylon.common.NonNull
            @Name("array")
...
extends BaseIterable<ceylon.language.Boolean, ceylon.language.Null> {
    ...
    public ceylon.language.Boolean getFirst() {
        return getEmpty() ? null : ceylon.language.Boolean.instance(this.array[this.start]);
    }
    
    
    @Override
    public ceylon.language.Boolean getLast() {
        return getEmpty() ? null : ceylon.language.Boolean.instance(this.array[this.end-1]);
    }
