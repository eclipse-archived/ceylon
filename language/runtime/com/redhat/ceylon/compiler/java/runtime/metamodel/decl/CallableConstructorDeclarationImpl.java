...
public class CallableConstructorDeclarationImpl
    ...
    @Ignore
    public static final TypeDescriptor $TypeDescriptor$ = TypeDescriptor.klass(CallableConstructorDeclarationImpl.class);
    ...
    public CallableConstructorDeclarationImpl(com.redhat.ceylon.model.typechecker.model.Functional function, Constructor constructor) {
    ...
    public boolean equals(Object other) {
        if (this == other) {
            return true;
        } else if (other instanceof CallableConstructorDeclarationImpl) {
            return getContainer().equals(((CallableConstructorDeclarationImpl)other).getContainer())
                    && getName().equals(((CallableConstructorDeclarationImpl)other).getName());
        } else {
            return false;
        }
    }
