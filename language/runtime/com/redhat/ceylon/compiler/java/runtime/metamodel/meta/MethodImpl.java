...
public class MethodImpl<Container, Type, Arguments extends Sequential<? extends Object>> 
    extends MemberImpl<Container, ceylon.language.meta.model.Function<? extends Type, ? super Arguments>> 
    ...
    public MethodImpl(@Ignore TypeDescriptor $reifiedContainer, 
    ...
    protected Function<Type, Arguments> bindTo(Object instance) {
        return new FunctionImpl<Type, Arguments>($reifiedType, $reifiedArguments, appliedFunction, declaration, getContainer(), instance);
    }

    @Ignore
    @Override
    public TypeDescriptor $getType$() {
        return TypeDescriptor.klass(MethodImpl.class, super.$reifiedContainer, $reifiedType, $reifiedArguments);
    }
