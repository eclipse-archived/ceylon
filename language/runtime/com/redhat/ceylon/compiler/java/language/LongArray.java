...
public final class LongArray implements ReifiedType {
    ...
    public static class LongArrayIterable implements ReifiedType, Iterable<ceylon.language.Integer, ceylon.language.Null> {
        ...
        public Sequential<? extends ceylon.language.Integer> sequence() {
            ...
            Object result = ceylon.language.notempty_.notempty(ceylon.language.Integer.$TypeDescriptor$,
                        ceylon.language.Null.$TypeDescriptor$,
                        LongArrayIterable.this);
            if (result == null) {
