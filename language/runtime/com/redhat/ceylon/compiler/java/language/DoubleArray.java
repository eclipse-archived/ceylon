...
public final class DoubleArray implements ReifiedType {
    ...
    public DoubleArray(
            ...
            @Name("array")
            @TypeInfo("{ceylon.language::Float*}")
            final Array<? extends ceylon.language.Float> array$param$) {
        throw Util.makeJavaArrayWrapperException();
    }*/
    ...
    @com.redhat.ceylon.common.NonNull
    @TypeInfo("com.redhat.ceylon.compiler.java.language::DoubleArray")
    @com.redhat.ceylon.compiler.java.metadata.Name("from")
    public static final DoubleArray from(@com.redhat.ceylon.common.NonNull
            @Name("array")
            @TypeInfo("ceylon.language::Array<java.lang::Double>|ceylon.language::Array<ceylon.language::Float>")
...
extends BaseIterable<ceylon.language.Float, ceylon.language.Null> {
    ...
    public ceylon.language.Float getFirst() {
        return getEmpty() ? null : ceylon.language.Float.instance(this.array[this.start]);
    }
    
    
    @Override
    public ceylon.language.Float getLast() {
        return getEmpty() ? null : ceylon.language.Float.instance(this.array[this.end-1]);
    }
