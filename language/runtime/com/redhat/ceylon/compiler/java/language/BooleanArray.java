...
public final class BooleanArray implements ReifiedType {
    ...
    public static class BooleanArrayIterable implements ReifiedType, Iterable<ceylon.language.Boolean, ceylon.language.Null> {
        ...
        //private final Correspondence$impl<ceylon.language.Integer, ceylon.language.Boolean> $ceylon$language$Correspondence$this = new Correspondence$impl<ceylon.language.Integer, ceylon.language.Boolean>(ceylon.language.Integer.$TypeDescriptor$, ceylon.language.Boolean.$TypeDescriptor$, this);
        ...
        //@Override
        //public Correspondence$impl<ceylon.language.Integer, ceylon.language.Boolean> $ceylon$language$Correspondence$impl() {
        ...
        @Override
        public Iterable<? extends ceylon.language.Boolean, ? extends Null> by(long step) {
        ...
        @Override
        public Iterable<? extends ceylon.language.Boolean, ? extends Object> getRest() {
            return $ceylon$language$Iterable$this.getRest();
        }
    
        @Override
        public Sequential<? extends ceylon.language.Boolean> getSequence() {
            return array.length == 0 ? empty_.get_() : new ArraySequence(ceylon.language.Boolean.$TypeDescriptor$, this);
        }
        ...
        public Iterator<? extends ceylon.language.Boolean> iterator() {
            return new Iterator<ceylon.language.Boolean>() {
                ...
                private final Iterator$impl<ceylon.language.Boolean> $ceylon$language$Iterator$this = new Iterator$impl<ceylon.language.Boolean>(ceylon.language.Boolean.$TypeDescriptor$, this);
                
                @Override
                public Iterator$impl<? extends ceylon.language.Boolean> $ceylon$language$Iterator$impl() {
                ...
                public Object next() {
                    if (index < array.length) {
                        return ceylon.language.Boolean.instance(array[index++]);
                    } else {
        ...
        @Override
        public Iterable<? extends ceylon.language.Boolean, ? extends Object> skipping(long skip) {
        ...
        @Override
        public Iterable<? extends ceylon.language.Boolean, ? extends Object> taking(long take) {
        ...
        @Override
        @Ignore
        @TypeInfo("ceylon.language::Boolean|ceylon.language::Null")
        public ceylon.language.Boolean get(
                @Name("key")
                ceylon.language.Integer key) {
            return ceylon.language.Boolean.instance(array[(int)key.longValue()]);
        }
        ...
        @Override
        @TypeInfo("ceylon.language::Sequential<ceylon.language::Boolean|ceylon.language.Null>")
        public ceylon.language.Sequential<? extends ceylon.language.Boolean> items(ceylon.language.Iterable<? extends ceylon.language.Integer, ? extends Object> keys) {
