...
public final class ByteArray implements ReifiedType {
    ...
    public ByteArray(
            ...
            @Name("array")
            @TypeInfo("{ceylon.language::Byte*}")
            final Array<? extends ceylon.language.Byte> array$param$) {
        throw Util.makeJavaArrayWrapperException();
    }*/
    ...
    @com.redhat.ceylon.compiler.java.metadata.Name("from")
    public static final ByteArray from(@com.redhat.ceylon.common.NonNull
            @Name("array")
            @TypeInfo("ceylon.language::Array<java.lang::Byte>|ceylon.language::Array<ceylon.language::Byte>")
...
extends BaseIterable<ceylon.language.Byte, ceylon.language.Null> {
    ...
    public ceylon.language.Byte getFirst() {
        return getEmpty() ? null : ceylon.language.Byte.instance(this.array[this.start]);
    }
    
    
    @Override
    public ceylon.language.Byte getLast() {
        return getEmpty() ? null : ceylon.language.Byte.instance(this.array[this.end-1]);
    }
