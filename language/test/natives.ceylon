...
native shared object baseNativeObject extends BaseClass(2) {
  shared String base2() => "Method in base object: ``natm()`` and ``natv``";
  native Integer natm();
  native Integer natv;
}

shared native("jvm") object baseNativeObject extends BaseClass(3) {
  native("jvm") Integer natm() => 2;
  native("jvm") Integer natv => 4;
}
shared native("js") object baseNativeObject extends BaseClass(4) {
