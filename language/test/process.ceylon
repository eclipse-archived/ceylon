...
shared void testProcess() {
    ...
    //language object
    check(language.version=="1.3.4-SNAPSHOT"/*@CEYLON_VERSION@*/, "language.version");
    ...
    check(language.releaseVersion==4/*@CEYLON_VERSION_RELEASE@*/, "language.releaseVersion");
    ...
    if (runtime.name == "jvm") {
        ...
        check(language.majorVersionBinary==10, "language.majorVersionBinary");
