...
shared void strings() {
    ...
    check("hello world".countOccurrences('l')==3, "string countOccurrences 1");
    check("hello world".countOccurrences('l',3)==2, "string countOccurrences 2");
    check(("hello world".firstOccurrence('l') else -1)==2, "string firstOccurrence 1");
    check(("hello world".firstOccurrence('l',3) else -1)==3, "string firstOccurrence 2");
    check(("hello world".lastOccurrence('l') else -1)==9, "string lastOccurrence 1");
    check(("hello world".lastOccurrence('l',9) else -1)==9, "string lastOccurrence 2");
    check(("hello world".lastOccurrence('l',8) else -1)==3, "string lastOccurrence 3");
    
    check("hello world".inclusions("wor").sequence()==[6], "string inclusions 1");
    check("hello world".inclusions("wor",5).sequence()==[6], "string inclusions 2");
    check("hello world".inclusions("wor",6).sequence()==[6], "string inclusions 3");
    check("hello world".inclusions("wor",7).sequence()==[], "string inclusions 4");
    check("hello world".includes("wor"), "string includes 1");
    check("hello world".includes("wor",5), "string includes 2");
    check("hello world".includes("wor",6), "string includes 3");
    check(!"hello world".includes("wor",7), "string includes 4");
    check("hello world".countInclusions("wor")==1, "string countInclusions 1");
    check("hello world".countInclusions("wor",5)==1, "string countInclusions 2");
    check("hello world".countInclusions("wor",6)==1, "string countInclusions 3");
    check("hello world".countInclusions("wor",7)==0, "string countInclusions 4");
    check(("hello world".firstInclusion("wor") else -1)==6, "string firstInclusion 1");
    check(("hello world".firstInclusion("wor",5) else -1)==6, "string firstInclusion 2");
    check(("hello world".firstInclusion("wor",6) else -1)==6, "string firstInclusion 3");
    check(!"hello world".firstInclusion("wor",7) exists, "string firstInclusion 4");
    check(("hello world".lastInclusion("wor") else -1)==6, "string lastInclusion 1");
    check(("hello world".lastInclusion("wor",7) else -1)==6, "string lastInclusion 2");
    check(("hello world".lastInclusion("wor",6) else -1)==6, "string lastInclusion 3");
    check(!"hello world".lastInclusion("wor",5) exists, "string lastInclusion 4");
