...
public final class @Classname@ implements ReifiedType {
    ...
    @Ignore
    @org.eclipse.ceylon.compiler.java.metadata.ConstructorName("with")
    ...
    @org.eclipse.ceylon.compiler.java.metadata.Name("with")
    public @Classname@(
            @Ignore
            with_ $name$,
    ...
    @Ignore
    @org.eclipse.ceylon.compiler.java.metadata.ConstructorName("from")
    public static final class from_ {
        private from_() {}
    };
    
    @ceylon.language.SharedAnnotation$annotation$
    @org.eclipse.ceylon.compiler.java.metadata.Name("from")
    public @Classname@(
            @Ignore
            from_ $name$,
            @org.eclipse.ceylon.common.NonNull
            @Name("array")
            @TypeInfo("{@BoxedTypeName@*}")
            final Array<? extends @BoxedType@> array$param$) {
        throw Util.makeJavaArrayWrapperException();
    }*/
    ...
    @org.eclipse.ceylon.common.NonNull
    @TypeInfo("org.eclipse.ceylon.compiler.java.language::@Classname@")
    @org.eclipse.ceylon.compiler.java.metadata.Name("from")
    public static final @Classname@ from(@org.eclipse.ceylon.common.NonNull
            @Name("array")
            @TypeInfo("@ArrayFromCeylonType@")
            final @ArrayFromJavaType@ array$param$) {
        throw Util.makeJavaArrayWrapperException();
    } 
...
extends BaseIterable<@BoxedType@, ceylon.language.Null> {
    ...
    public @Classname@Iterable by(long step) {
        return new @Classname@Iterable(this.array, 
                this.start, 
                this.end, 
                org.eclipse.ceylon.compiler.java.Util.toInt(this.step*step));
    }
    ...
    public @Classname@Iterable skip(long skip) {
        ...
        return new @Classname@Iterable(this.array, 
                org.eclipse.ceylon.compiler.java.Util.toInt(this.start+skip*this.step), 
                this.end, 
                this.step);
    }
    ...
    public @Classname@Iterable take(long take) {
        ...
        return new @Classname@Iterable(this.array, 
                this.start, 
                org.eclipse.ceylon.compiler.java.Util.toInt(this.start+take*this.step), 
                this.step);
    }
