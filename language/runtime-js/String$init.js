initExistingType($_String, String, 'ceylon.language::String', $_Object, $i$SearchableList(), $i$Comparable(),
        $i$Ranged(), $i$Summable());
...
str$proto.$a$={Element$Iterable:{t:Character}, Absent$Iterable:{t:Null},
