function AppliedAttribute(pname, atr,$a$,that){
  ...
  },undefined,function(){return{mod:$M$,$t:{t:Type$meta$model,a:{Type$Type:'Get$Attribute'}},$cont:AppliedAttribute,an:function(){return[shared(),actual()];},d:['ceylon.language.meta.model','Attribute','$at','type']};});
  ...
  },undefined,function(){return{mod:$M$,$t:{t:ValueDeclaration$meta$declaration},$cont:AppliedAttribute,an:function(){return[shared(),actual()];},d:['ceylon.language.meta.model','Attribute','$at','declaration']};});
  ...
  atr$(that,'string',function(){
    ...
    qn+="."+pname;
    return qn;
  },undefined,function(){return{mod:$M$,$t:{t:$_String},d:['$','Object','$at','string']};});
  atr$(that,'container',function(){
    return AppliedValue$jsint.$$.prototype.$prop$getContainer.get.call(this);
  },undefined,function(){return{mod:$M$,$t:{t:Type$meta$model,a:{Type$Type:{t:Anything}}},$cont:AppliedAttribute,pa:67,d:['ceylon.language.jsint','Member','$at','container']};});
  that.equals=function(o) {
    return is$(o,{t:AppliedAttribute}) && o.tipo===atr;
  }
  atr$(that,'hash',function(){
    return this.string.hash;
  },undefined,function(){return{mod:$M$,$t:{t:Integer},$cont:AppliedAttribute,pa:67,d:['ceylon.language','Object','$at','hash']};});
  return that;
}
AppliedAttribute.$m$=function(){return{mod:$M$,'super':{t:Basic},tp:{Get:{dv:'out','def':{t:Anything}},Set:{dv:'in','def':{t:Nothing}},Container:{dv:'in'}},sts:[{t:Attribute$meta$model,a:{Get:'Get',Set:'Set',Container:'Container'}}],pa:1,d:['ceylon.language.meta.model','Attribute']};};
x$.AppliedAttribute=AppliedAttribute;
...
x$.$i$AppliedAttribute$meta$model=$i$AppliedAttribute;
$i$AppliedAttribute();
