...
* `src`       - the Ceylon CMR javascript support module sources
* `test-src`  - the Ceylon CMR javascript support module unit tests
...
Once built, the module lives in this jar:
    ...
    ~/.ceylon/repo/org/eclipse/ceylon/module-resolver-javascript/0.2/org.eclipse.ceylon.module-resolver-javascript-0.2.jar
