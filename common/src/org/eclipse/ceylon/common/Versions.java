...
public class Versions {
    ...
    // The current version is Ceylon "1.3.4-SNAPSHOT"@CEYLON_VERSION@ "You'll Thank Me Later"@CEYLON_VERSION_NAME@
    ...
    * - ceylon-ide-eclipse/plugins/org.eclipse.ceylon.eclipse.ui/about.ini (version, name)
    ...
    * - *.java,*.src @(\.?org.eclipse.ceylon.compiler.java.metadata.)?Ceylon\(\s*major\s*=\s*6 -> @$1Version(major = 7
    *
    * If you bump the SDK:
    * - ceylon-sdk/source
    ...
    ****************************************************************************************************/
     ...
     */
    public static final String CEYLON_VERSION_NAME = "You'll Thank Me Later"/*@CEYLON_VERSION_NAME@*/;
    ...
    public static final String DEPENDENCY_JBOSS_MODULES_VERSION = "1.8.6.Final";
