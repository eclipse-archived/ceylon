...
import org.eclipse.ceylon.common.config.Authentication.UsernamePassword;
...
public class AuthenticationTest extends AbstractKeystoreTest {
    ...
    public void loadConfig() throws IOException {
        this.testConfig = super.loadConfig("test/src/org/eclipse/ceylon/common/test/authentication.config");
