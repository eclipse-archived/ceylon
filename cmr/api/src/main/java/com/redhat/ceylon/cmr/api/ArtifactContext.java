...
public class ArtifactContext implements Serializable, ContentOptions {
    ...
    // These contain only user supplied suffixes, not ones that get generated by the system like INFO
    public static final String[] userSuffixes = { CAR, CAR + SHA1, JAR, JAR + SHA1, JS, JS + SHA1, ZIP, ZIP + SHA1, SRC, SRC + SHA1, DOCS_ZIPPED, DOCS_ZIPPED + SHA1, MODULE_PROPERTIES, MODULE_XML };
