...
nodeList : {
           ...
           println("import static org.eclipse.ceylon.compiler.typechecker.tree.Walker.*;\n");
...
field : t=TYPE_NAME f=FIELD_NAME
          { println("        private org.eclipse.ceylon.model.typechecker.model." + $t.text + " " + $f.text+ ";"); }
          { println("        public org.eclipse.ceylon.model.typechecker.model." + $t.text + " get" + initialUpper($f.text) + "() { return " + $f.text + "; }"); }
          { println("        public void set" + initialUpper($f.text) + "(org.eclipse.ceylon.model.typechecker.model." + $t.text + " value) { " + $f.text + " = value; }\n"); }
        ';'
      ...
      | l=TYPE_NAME '<' t=TYPE_NAME '>' f=FIELD_NAME
          { println("        private " + $l.text + "<org.eclipse.ceylon.model.typechecker.model." + $t.text + "> " + $f.text+ ";"); }
          { println("        public " + $l.text + "<org.eclipse.ceylon.model.typechecker.model." + $t.text + "> get" + initialUpper($f.text) + "() { return " + $f.text + "; }"); }
          { println("        public void set" + initialUpper($f.text) + "(" + $l.text + "<org.eclipse.ceylon.model.typechecker.model." + $t.text + "> value) { " + $f.text + " = value; }\n"); }
        ';'
      | 'abstract' t=TYPE_NAME f=FIELD_NAME
          { println("        public abstract org.eclipse.ceylon.model.typechecker.model." + $t.text + " get" + initialUpper($f.text) + "();\n"); }
        ';'
      ;
