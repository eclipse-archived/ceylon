...
class E2<T>(String name, T t) given T satisfies Value => Entry<String,T>(name,t);
class E3<T>(T t, String s) given T satisfies Value => Entry<T,String>(t,s);
...
Entry<String,T> e2<T>(String name, T t) given T satisfies Value => Entry<String,T>(name,t);
Entry<String,Integer> e3(String name, Integer i) => Entry(name,i);
@error Callable<Entry<Value,Value>,Value,Value> e5 = Entry;
class F() => Float();
