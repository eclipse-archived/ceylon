...
import static org.eclipse.ceylon.compiler.typechecker.analyzer.TypeVisitor.getTupleType;
import static org.eclipse.ceylon.compiler.typechecker.parser.CeylonLexer.SPECIFY;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.buildAnnotations;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.formatPath;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.getAnnotation;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.getAnnotationArgument;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.getAnnotationArgumentCount;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.getAnnotationSequenceArgument;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.getNativeBackend;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.hasAnnotation;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.hasAnonymousAnnotation;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.name;
import static org.eclipse.ceylon.compiler.typechecker.tree.TreeUtil.setRestrictionArgument;
...
import org.eclipse.ceylon.model.typechecker.model.Element;
...
//                Scope scope = model.getContainer();
     ...
     * 
     * @see org.eclipse.ceylon.model.typechecker.model.ConditionScope
     */
