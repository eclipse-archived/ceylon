...
public class SerializationHelper {
    ...
    static void addSerializer(final Node node, final org.eclipse.ceylon.model.typechecker.model.Class d,
    ...
    private static void serializeRefs(final Node that, final String typename, final Class owner,
        ...
        for (Value v : vals) {
            ...
            gen.out(gen.getClAlias(), "MemberImpl$impl(", gen.getClAlias(), "OpenValue$jsint(",
                    gen.getClAlias(), "lmp$(x$,'", "ceylon.language".equals(pkgname) ? "$" : pkgname,
    ...
    static void addDeserializer(final Node that, final org.eclipse.ceylon.model.typechecker.model.Class d,
            final GenerateJsVisitor gen) {
    ...
    private static boolean setDeserializedTypeArguments(final org.eclipse.ceylon.model.typechecker.model.Class root,
    ...
    static List<Value> serializableValues(org.eclipse.ceylon.model.typechecker.model.Class d) {
