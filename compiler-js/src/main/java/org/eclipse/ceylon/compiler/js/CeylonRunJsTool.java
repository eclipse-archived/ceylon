...
public class CeylonRunJsTool extends RepoUsingTool {
    ...
    public void initialize(CeylonTool mainTool) throws Exception {
        ...
        if (module == null) {
            module = DefaultToolOptions.getRunToolModule(org.eclipse.ceylon.common.Backend.JavaScript);
            if (module != null) {
                if (func == null) {
                    func = DefaultToolOptions.getRunToolRun(org.eclipse.ceylon.common.Backend.JavaScript);
                }
                if (args == null || args.isEmpty()) {
                    args = DefaultToolOptions.getRunToolArgs(org.eclipse.ceylon.common.Backend.JavaScript);
                }
            } else {
