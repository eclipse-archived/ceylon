...
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_ANNOTATIONS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_ATTRIBUTES;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_CLASSES;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_CONSTRUCTOR;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_CONSTRUCTORS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_DEFAULT;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_DS_VARIANCE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_DYNAMIC;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_FLAGS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_INTERFACES;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_JS_TSENUM;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_METATYPE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_METHODS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_MODULE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_NAME;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_OBJECTS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_PACKAGE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_PACKED_ANNS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_PARAMS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_SATISFIES;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_SELF_TYPE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_TYPE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_TYPES;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_TYPE_ARGS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_TYPE_PARAMS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.KEY_US_VARIANCE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.METATYPE_ALIAS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.METATYPE_ATTRIBUTE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.METATYPE_CLASS;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.METATYPE_GETTER;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.METATYPE_INTERFACE;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.METATYPE_METHOD;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.METATYPE_OBJECT;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.annotationBits;
import static org.eclipse.ceylon.compiler.js.loader.MetamodelGenerator.partiallyQualifiedName;
...
public class JsonPackage extends LazyPackage {
    ...
    public void setModule(org.eclipse.ceylon.model.typechecker.model.Module module) {
            ...
            if (!k.startsWith("$pkg-")) {
                ...
                if (m.get(KEY_METATYPE) instanceof String) {
                    ...
                    if (METATYPE_CLASS.equals(metatype)) {
                        ...
                        refineMembers((org.eclipse.ceylon.model.typechecker.model.Class)loadObject(k, m, this, null));
    ...
    @SuppressWarnings("unchecked")
    org.eclipse.ceylon.model.typechecker.model.Class loadClass(String name, Map<String, Object> m,
    ...
    Declaration load(String name, List<TypeParameter> existing) {
        ...
        } else if (metatype.equals(METATYPE_CLASS) || metatype instanceof org.eclipse.ceylon.model.typechecker.model.Class) {
            return loadClass(name, map, this, existing);
        } else if (metatype.equals(METATYPE_INTERFACE) || metatype instanceof org.eclipse.ceylon.model.typechecker.model.Interface) {
    ...
    private void setBitAnnotations(Declaration d, int bits) {
        ...
        if (d instanceof org.eclipse.ceylon.model.typechecker.model.Class) {
            ((org.eclipse.ceylon.model.typechecker.model.Class)d).setFinal(hasAnnotationBit(bits, "final"));
            ((org.eclipse.ceylon.model.typechecker.model.Class)d).setAbstract(hasAnnotationBit(bits, "abstract"));
