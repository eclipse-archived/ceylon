    ...
    if (MySequence.$$===undefined){
        ...
        (function($$mySequence){
            ...
            $$mySequence.getLastIndex=function getLastIndex(){
                var $$mySequence=this;
                return $$mySequence.seq$141$.getLastIndex();
            }
            
            //AttributeGetterDefinition first at functions.ceylon (28:4-28:52)
            $$mySequence.getFirst=function getFirst(){
                var $$mySequence=this;
                return $$mySequence.seq$141$.getFirst();
            }
            
            //AttributeGetterDefinition rest at functions.ceylon (29:4-29:52)
            $$mySequence.getRest=function getRest(){
                var $$mySequence=this;
                return $$mySequence.seq$141$.getRest();
            }
            
            //MethodDefinition item at functions.ceylon (30:4-30:68)
            $$mySequence.item=function item(index$142){
                var $$mySequence=this;
                return $$mySequence.seq$141$.item(index$142);
            }
            
            //MethodDefinition span at functions.ceylon (31:4-31:89)
            $$mySequence.span=function span(from$143,to$144){
                var $$mySequence=this;
                return $$mySequence.seq$141$.span(from$143,to$144);
            }
            
            //MethodDefinition segment at functions.ceylon (32:4-32:102)
            $$mySequence.segment=function segment(from$145,length$146){
                var $$mySequence=this;
                return $$mySequence.seq$141$.segment(from$145,length$146);
            }
            ...
            $$mySequence.getString=function getString(){
                var $$mySequence=this;
                return $$mySequence.seq$141$.getString();
            }
            
            //AttributeGetterDefinition hash at functions.ceylon (35:4-35:50)
            $$mySequence.getHash=function getHash(){
                var $$mySequence=this;
                return $$mySequence.seq$141$.getHash();
            }
            
            //MethodDefinition equals at functions.ceylon (36:4-36:75)
            $$mySequence.equals=function equals(other$147){
                var $$mySequence=this;
                return $$mySequence.seq$141$.equals(other$147);
            }
...
function DefParamTest1(i1$156$, i2$157$, i3$158$, $$defParamTest1){
    ...
    $$defParamTest1.s$159$=$$$cl1.StringBuilder().appendAll($$$cl1.ArraySequence([$$$cl1.String("",0),i1$156$.getString(),$$$cl1.String(",",1),i2$157$.getString(),$$$cl1.String(",",1),i3$158$.getString(),$$$cl1.String("",0)])).getString();
...
function DefParamTest2(i1$160$, i2$161$, i3$162$, $$defParamTest2){
    ...
    if(i2$161$===undefined){i2$161$=$$defParamTest2.i1$160$.plus($$$cl1.Integer(1));}
    $$defParamTest2.i2$161$=i2$161$;
    if(i3$162$===undefined){i3$162$=$$defParamTest2.i1$160$.plus($$defParamTest2.i2$161$);}
    ...
    if (DefParamTest2.$$===undefined){
        ...
        (function($$defParamTest2){
            ...
            $$defParamTest2.f=function f(){
                ...
                return $$$cl1.StringBuilder().appendAll($$$cl1.ArraySequence([$$$cl1.String("",0),$$defParamTest2.i1$160$.getString(),$$$cl1.String(",",1),$$defParamTest2.i2$161$.getString(),$$$cl1.String(",",1),$$defParamTest2.i3$162$.getString(),$$$cl1.String("",0)])).getString();
            }
...
function $init$DefParamTest3(){
    if (DefParamTest3.$$===undefined){
        ...
        (function($$defParamTest3){
            ...
            $$defParamTest3.f=function f(i1$163,i2$164,i3$165){
...
function testGetterMethodDefinitions(){
    ...
    function GetterTest$167($$getterTest$167){
        ...
        $$getterTest$167.i$168$=$$$cl1.Integer(0);
    ...
    function $init$GetterTest$167(){
        if (GetterTest$167.$$===undefined){
            ...
            (function($$getterTest$167){
                
                //AttributeDeclaration i at functions.ceylon (100:4-100:25)
                $$getterTest$167.getI$168$=function getI$168$(){
                    return this.i$168$;
                }
                $$getterTest$167.setI$168$=function setI$168$(i$169){
                    this.i$168$=i$169; return i$169;
                }
                
                //AttributeGetterDefinition x at functions.ceylon (101:4-101:35)
                $$getterTest$167.getX=function getX(){
                    var $$getterTest$167=this;
                    return ($$getterTest$167.setI$168$($$getterTest$167.getI$168$().getSuccessor()),$$getterTest$167.getI$168$());
                }
                
            })(GetterTest$167.$$.prototype);
