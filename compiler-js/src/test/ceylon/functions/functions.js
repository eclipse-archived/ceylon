...
function testAnonymous(){
    ...
    var found$333=find(nums$331,function (i$334){
    ...
    callFunction$341(f$344,$$$cl1.String("12",2));
    callFunction$341(function (i$346){
    ...
    var f2$350=function (i$351){
        return i$351.minus((10)).string;
    };
    callFunction$341(f2$350,$$$cl1.String("-10",3));
    callFunction$341(subtract((5)),$$$cl1.String("-5",2));
    found$333=find2(nums$331,function (i$352){
...
function MySequence(seq$362, $$targs$$,$$mySequence){
    ...
    $$$cl1.defineAttr($$mySequence,'iterator',function(){return seq$362.iterator;});
...
function testMethodReference(){
    ...
    $$$c2.check(tst$375((opt$377=obj1$373,$$$cl1.JsCallable(opt$377,opt$377!==null?opt$377.f:null))),$$$cl1.String("Reference to method",19));
    var opt$377;
    $$$c2.check(tst$375((opt$378=obj2$374,$$$cl1.JsCallable(opt$378,opt$378!==null?opt$378.defines:null))),$$$cl1.String("Reference to method from ceylon.language",40));
    var opt$378;
};
