...
function testNullsafeOperators(){
    ...
    var f2$335=(function(){var tmpvar$336=obj$332; return $$$cl275.JsCallable(tmpvar$336,tmpvar$336===null?null:tmpvar$336.f);}());
    ...
    var f3$337=(function(){var tmpvar$338=obj$332; return $$$cl275.JsCallable(tmpvar$338,tmpvar$338===null?null:tmpvar$338.f);}());
    assert($$$cl275.exists(f3$337),$$$cl275.String("nullsafe method ref 2",21));
    (function(){var tmpvar$339=obj$332; return $$$cl275.JsCallable(tmpvar$339,tmpvar$339===null?null:tmpvar$339.f);}())();
    assert($$$cl275.exists((function(){var tmpvar$340=obj$332; return $$$cl275.JsCallable(tmpvar$340,tmpvar$340===null?null:tmpvar$340.f);}())()).equals($$$cl275.getFalse()),$$$cl275.String("nullsafe simple call",20));
    
    //MethodDefinition getNullsafe at operators.ceylon (220:4-220:46)
    function getNullsafe$341(){
        return obj$332;
    }
    
    //MethodDeclaration f4 at operators.ceylon (221:4-221:36)
    var f4$342=(function(){var tmpvar$343=getNullsafe$341(); return $$$cl275.JsCallable(tmpvar$343,tmpvar$343===null?null:tmpvar$343.f);}());
    
    //AttributeDeclaration result_f4 at operators.ceylon (222:4-222:29)
    var result_f4$344=f4$342();
    assert($$$cl275.exists(result_f4$344).equals($$$cl275.getFalse()),$$$cl275.String("nullsafe invoke 2",17));
    
    //AttributeDeclaration i2 at operators.ceylon (224:4-224:36)
    var i2$345=(function(){var tmpvar$346=getNullsafe$341(); return $$$cl275.JsCallable(tmpvar$346,tmpvar$346===null?null:tmpvar$346.f);}())();
    assert($$$cl275.exists(i2$345).equals($$$cl275.getFalse()),$$$cl275.String("nullsafe invoke 3",17));
    assert($$$cl275.exists(NullsafeTest().f2((function(){var tmpvar$347=getNullsafe$341(); return $$$cl275.JsCallable(tmpvar$347,tmpvar$347===null?null:tmpvar$347.f);}()))).equals($$$cl275.getFalse()),$$$cl275.String("nullsafe method ref 3",21));
}
...
function testIncDecOperators(){
    ...
    var i1$348=$$$cl275.Integer(1);
    var setI1$348=function(i1$349){i1$348=i1$349; return i1$348;};
    
    //MethodDefinition f1 at operators.ceylon (231:4-235:4)
    function f1$350(){
        
        //AttributeDeclaration i2 at operators.ceylon (232:8-232:25)
        var i2$351=(setI1$348(i1$348.getSuccessor()),i1$348);
        assert(i1$348.equals($$$cl275.Integer(2)),$$$cl275.String("prefix increment",16));
        assert(i2$351.equals($$$cl275.Integer(2)),$$$cl275.String("prefix increment",16));
    }
    f1$350();
    
    //ClassDefinition C1 at operators.ceylon (238:4-238:49)
    function C1$352($$c1$352){
        if ($$c1$352===undefined)$$c1$352=new C1$352.$$;
        
        //AttributeDeclaration i at operators.ceylon (238:17-238:47)
        var i$353=$$$cl275.Integer(1);
        var getI=function(){return i$353;};
        $$c1$352.getI=getI;
        var setI=function(i$354){i$353=i$354; return i$353;};
        $$c1$352.setI=setI;
        return $$c1$352;
    }
    $$$cl275.initTypeProto(C1$352,'operators.testIncDecOperators.C1',$$$cl275.IdentifiableObject);
    
    //AttributeDeclaration c1 at operators.ceylon (239:4-239:16)
    var c1$355=C1$352();
    
    //AttributeDeclaration i3 at operators.ceylon (240:4-240:28)
    var i3$356=$$$cl275.Integer(0);
    var setI3$356=function(i3$357){i3$356=i3$357; return i3$356;};
    
    //MethodDefinition f2 at operators.ceylon (241:4-244:4)
    function f2$358(){
        (setI3$356(i3$356.getSuccessor()),i3$356);
        return c1$355;
    }
    
    //AttributeDeclaration i4 at operators.ceylon (245:4-245:25)
    var i4$359=function($){var $2=$.getI().getSuccessor();$.setI($2);return $2}(f2$358());
    assert(i4$359.equals($$$cl275.Integer(2)),$$$cl275.String("prefix increment",16));
    assert(c1$355.getI().equals($$$cl275.Integer(2)),$$$cl275.String("prefix increment",16));
    assert(i3$356.equals($$$cl275.Integer(1)),$$$cl275.String("prefix increment",16));
    
    //MethodDefinition f3 at operators.ceylon (250:4-254:4)
    function f3$360(){
        
        //AttributeDeclaration i2 at operators.ceylon (251:8-251:25)
        var i2$361=(setI1$348(i1$348.getPredecessor()),i1$348);
        assert(i1$348.equals($$$cl275.Integer(1)),$$$cl275.String("prefix decrement",16));
        assert(i2$361.equals($$$cl275.Integer(1)),$$$cl275.String("prefix decrement",16));
    }
    f3$360();
    
    //AttributeDeclaration i5 at operators.ceylon (257:4-257:25)
    var i5$362=function($){var $2=$.getI().getPredecessor();$.setI($2);return $2}(f2$358());
    assert(i5$362.equals($$$cl275.Integer(1)),$$$cl275.String("prefix decrement",16));
    assert(c1$355.getI().equals($$$cl275.Integer(1)),$$$cl275.String("prefix decrement",16));
    assert(i3$356.equals($$$cl275.Integer(2)),$$$cl275.String("prefix decrement",16));
    
    //MethodDefinition f4 at operators.ceylon (262:4-266:4)
    function f4$363(){
        
        //AttributeDeclaration i2 at operators.ceylon (263:8-263:25)
        var i2$364=(function($){setI1$348($.getSuccessor());return $}(i1$348));
        assert(i1$348.equals($$$cl275.Integer(2)),$$$cl275.String("postfix increment",17));
        assert(i2$364.equals($$$cl275.Integer(1)),$$$cl275.String("postfix increment",17));
    }
    f4$363();
    
    //AttributeDeclaration i6 at operators.ceylon (269:4-269:25)
    var i6$365=function($){var $2=$.getI();$.setI($2.getSuccessor());return $2}(f2$358());
    assert(i6$365.equals($$$cl275.Integer(1)),$$$cl275.String("postfix increment",17));
    assert(c1$355.getI().equals($$$cl275.Integer(2)),$$$cl275.String("postfix increment",17));
    assert(i3$356.equals($$$cl275.Integer(3)),$$$cl275.String("postfix increment",17));
    
    //MethodDefinition f5 at operators.ceylon (274:4-278:4)
    function f5$366(){
        
        //AttributeDeclaration i2 at operators.ceylon (275:8-275:25)
        var i2$367=(function($){setI1$348($.getPredecessor());return $}(i1$348));
        assert(i1$348.equals($$$cl275.Integer(1)),$$$cl275.String("postfix decrement",17));
        assert(i2$367.equals($$$cl275.Integer(2)),$$$cl275.String("postfix decrement",17));
    }
    f5$366();
    
    //AttributeDeclaration i7 at operators.ceylon (281:4-281:25)
    var i7$368=function($){var $2=$.getI();$.setI($2.getPredecessor());return $2}(f2$358());
    assert(i7$368.equals($$$cl275.Integer(2)),$$$cl275.String("postfix decrement",17));
    assert(c1$355.getI().equals($$$cl275.Integer(1)),$$$cl275.String("postfix decrement",17));
    assert(i3$356.equals($$$cl275.Integer(4)),$$$cl275.String("postfix decrement",17));
}
...
function testArithmeticAssignOperators(){
    ...
    var i1$369=$$$cl275.Integer(1);
    var setI1$369=function(i1$370){i1$369=i1$370; return i1$369;};
    (setI1$369(i1$369.plus($$$cl275.Integer(10))),i1$369);
    assert(i1$369.equals($$$cl275.Integer(11)),$$$cl275.String("+= operator",11));
    
    //AttributeDeclaration i2 at operators.ceylon (292:4-292:37)
    var i2$371=(setI1$369(i1$369.plus($$$cl275.Integer(5).getNegativeValue())),i1$369);
    var setI2$371=function(i2$372){i2$371=i2$372; return i2$371;};
    assert(i2$371.equals($$$cl275.Integer(6)),$$$cl275.String("+= operator",11));
    assert(i1$369.equals($$$cl275.Integer(6)),$$$cl275.String("+= operator",11));
    
    //ClassDefinition C1 at operators.ceylon (296:4-296:49)
    function C1$373($$c1$373){
        if ($$c1$373===undefined)$$c1$373=new C1$373.$$;
        
        //AttributeDeclaration i at operators.ceylon (296:17-296:47)
        var i$374=$$$cl275.Integer(1);
        var getI=function(){return i$374;};
        $$c1$373.getI=getI;
        var setI=function(i$375){i$374=i$375; return i$374;};
        $$c1$373.setI=setI;
        return $$c1$373;
    }
    $$$cl275.initTypeProto(C1$373,'operators.testArithmeticAssignOperators.C1',$$$cl275.IdentifiableObject);
    
    //AttributeDeclaration c1 at operators.ceylon (297:4-297:16)
    var c1$376=C1$373();
    
    //AttributeDeclaration i3 at operators.ceylon (298:4-298:28)
    var i3$377=$$$cl275.Integer(0);
    var setI3$377=function(i3$378){i3$377=i3$378; return i3$377;};
    
    //MethodDefinition f at operators.ceylon (299:4-302:4)
    function f$379(){
        (setI3$377(i3$377.getSuccessor()),i3$377);
        return c1$376;
    }
    setI2$371((function($1,$2){var $=$1.getI().plus($2);$1.setI($);return $}(f$379(),$$$cl275.Integer(11))));
    assert(i2$371.equals($$$cl275.Integer(12)),$$$cl275.String("+= operator",11));
    assert(c1$376.getI().equals($$$cl275.Integer(12)),$$$cl275.String("+= operator",11));
    assert(i3$377.equals($$$cl275.Integer(1)),$$$cl275.String("+= operator",11));
    setI2$371((setI1$369(i1$369.minus($$$cl275.Integer(14))),i1$369));
    assert(i1$369.equals($$$cl275.Integer(8).getNegativeValue()),$$$cl275.String("-= operator",11));
    assert(i2$371.equals($$$cl275.Integer(8).getNegativeValue()),$$$cl275.String("-= operator",11));
    setI2$371((setI1$369(i1$369.times($$$cl275.Integer(3).getNegativeValue())),i1$369));
    assert(i1$369.equals($$$cl275.Integer(24)),$$$cl275.String("*= operator",11));
    assert(i2$371.equals($$$cl275.Integer(24)),$$$cl275.String("*= operator",11));
    setI2$371((setI1$369(i1$369.divided($$$cl275.Integer(5))),i1$369));
    assert(i1$369.equals($$$cl275.Integer(4)),$$$cl275.String("/= operator",11));
    assert(i2$371.equals($$$cl275.Integer(4)),$$$cl275.String("/= operator",11));
    setI2$371((setI1$369(i1$369.remainder($$$cl275.Integer(3))),i1$369));
    assert(i1$369.equals($$$cl275.Integer(1)),$$$cl275.String("%= operator",11));
    assert(i2$371.equals($$$cl275.Integer(1)),$$$cl275.String("%= operator",11));
}
