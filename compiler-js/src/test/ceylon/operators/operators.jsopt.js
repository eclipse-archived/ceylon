...
function $init$NullsafeTest(){
    if (NullsafeTest.$$===undefined){
        ...
        (function($$nullsafeTest){
            ...
            $$nullsafeTest.f2=function f2(x$426){
                var $$nullsafeTest=this;
                return x$426();
            }
    ...
    function $init$C1$461(){
        if (C1$461.$$===undefined){
            ...
            (function($$c1$461){
                ...
                //AttributeDeclaration i at operators.ceylon (232:17-232:47)
                $$c1$461.getI=function getI(){
                    return this.i$462$;
                }
                $$c1$461.setI=function setI(i$463){
                    this.i$462$=i$463; return i$463;
                }
    ...
    function $init$C1$482(){
        if (C1$482.$$===undefined){
            ...
            (function($$c1$482){
                ...
                //AttributeDeclaration i at operators.ceylon (290:17-290:47)
                $$c1$482.getI=function getI(){
                    return this.i$483$;
                }
                $$c1$482.setI=function setI(i$484){
                    this.i$483$=i$484; return i$484;
                }
