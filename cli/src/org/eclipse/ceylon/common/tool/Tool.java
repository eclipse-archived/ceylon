 ...
 * <dl>
 * <dt>{@link Option}</dt>
 *   <dd>For {@linkplain  org.eclipse.ceylon.common.tool pure options}</dd>
 * <dt>{@link OptionArgument}</dt>
 *   <dd>For {@linkplain  org.eclipse.ceylon.common.tool option arguments}</dd>
 * <dt>{@link Argument}</dt>
 *   <dd>For {@linkplain  org.eclipse.ceylon.common.tool arguments}</dd>
 * <dt>{@link Rest}</dt>
