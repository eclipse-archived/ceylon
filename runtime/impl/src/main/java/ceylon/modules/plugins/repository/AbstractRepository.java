...
public abstract class AbstractRepository implements Repository
{
    ...
    * @return module's identifier
    */
   protected ModuleIdentifier createModuleIdentifier(ModuleName name, ModuleVersion version)
   {
      return ModuleIdentifier.create(name.getName(), version.toString());  
   }
