...
echo find compiler-java/test/src/ -name '*.ceylon' -or -name '*.src' -or -name '*.properties' 
echo xargs perl -pi -e "s/${CEYLON_RELEASE_VERSION_MAJOR}.${CEYLON_RELEASE_VERSION_MINOR}.${CEYLON_RELEASE_VERSION_RELEASE}-SNAPSHOT/$CEYLON_RELEASE_VERSION_MAJOR.$CEYLON_RELEASE_VERSION_MINOR.$CEYLON_RELEASE_VERSION_RELEASE/g"
