 ...
 ********************************************************************************/
package org.eclipse.ceylon.model.loader.impl.reflect;
...
import org.eclipse.ceylon.common.Java9ModuleUtil;
...
public abstract class ReflectionModelLoader extends AbstractModelLoader {
    ...
    public boolean loadPackage(Module module, String packageName, boolean loadDeclarations) {
        ...
        if(!packageExists(module, packageName))
            return false;
        if(loadDeclarations){
            // HUGE HACK because JBoss modules hides this package at runtime
            if(!packageName.startsWith("org.jboss.modules._private.")
                    && !packageName.equals("org.jboss.modules._private")){
