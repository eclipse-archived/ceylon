...
*/
        ...
        private String getRequireBundle() {
            ...
            for (ModuleImport anImport : module.getImports()) {
                ...
                if ("org.eclipse.ceylon.dist".equals(moduleName)) {
                ...
                if (!jdkProvider.isJDKModule(moduleName)
                    ...
                    boolean isFromCeylonDistribution = module.getLanguageModule().getVersion().equals(depVersion) &&
                            (m.getNameAsString().startsWith("ceylon.") || m.getNameAsString().startsWith("org.eclipse.ceylon."));
            ...
            if (! distImportAlreadyFound) {
                ...
                requires.append("org.eclipse.ceylon.dist")
        ...
        private String getExportPackage() {
            ...
            if (isLanguageModule()) {
                ...
                exportPackage.append("org.eclipse.ceylon.dist.osgi");
                exportPackage.append(";version=").append(OsgiVersion.fromCeylonVersion(module.getVersion()));
            }
