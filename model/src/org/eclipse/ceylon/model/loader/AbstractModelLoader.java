...
import org.eclipse.ceylon.model.loader.mirror.AccessibleMirror;
...
import org.eclipse.ceylon.model.loader.model.JavaParameterValue;
import org.eclipse.ceylon.model.loader.model.LazyClass;
import org.eclipse.ceylon.model.loader.model.LazyClassAlias;
import org.eclipse.ceylon.model.loader.model.LazyContainer;
import org.eclipse.ceylon.model.loader.model.LazyElement;
...
import org.eclipse.ceylon.model.loader.model.SetterWithLocalDeclarations;
import org.eclipse.ceylon.model.typechecker.model.Annotated;
...
import org.eclipse.ceylon.model.typechecker.model.DeclarationCompleter;
...
public abstract class AbstractModelLoader implements ModelCompleter, ModelLoader, DeclarationCompleter {
    ...
    public static final String CEYLON_CEYLON_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Ceylon";
    protected static final String CEYLON_MODULE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Module";
    protected static final String CEYLON_PACKAGE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Package";
    public static final String CEYLON_IGNORE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Ignore";
    private static final String CEYLON_CLASS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Class";
    private static final String CEYLON_JPA_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Jpa";
    private static final String CEYLON_ENUMERATED_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Enumerated";
    //private static final String CEYLON_CONSTRUCTOR_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Constructor";
    //private static final String CEYLON_PARAMETERLIST_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.ParameterList";
    public static final String CEYLON_NAME_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Name";
    private static final String CEYLON_SEQUENCED_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Sequenced";
    private static final String CEYLON_FUNCTIONAL_PARAMETER_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.FunctionalParameter";
    private static final String CEYLON_DEFAULTED_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Defaulted";
    private static final String CEYLON_SATISFIED_TYPES_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.SatisfiedTypes";
    private static final String CEYLON_CASE_TYPES_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.CaseTypes";
    private static final String CEYLON_TYPE_PARAMETERS = "org.eclipse.ceylon.compiler.java.metadata.TypeParameters";
    private static final String CEYLON_TYPE_INFO_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.TypeInfo";
    public static final String CEYLON_ATTRIBUTE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Attribute";
    public static final String CEYLON_SETTER_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Setter";
    public static final String CEYLON_OBJECT_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Object";
    public static final String CEYLON_METHOD_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Method";
    public static final String CEYLON_CONTAINER_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Container";
    public static final String CEYLON_LOCAL_CONTAINER_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.LocalContainer";
    public static final String CEYLON_LOCAL_DECLARATION_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.LocalDeclaration";
    public static final String CEYLON_LOCAL_DECLARATIONS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.LocalDeclarations";
    private static final String CEYLON_MEMBERS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Members";
    private static final String CEYLON_ANNOTATIONS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Annotations";
    public static final String CEYLON_VALUETYPE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.ValueType";
    public static final String CEYLON_ALIAS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Alias";
    public static final String CEYLON_TYPE_ALIAS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.TypeAlias";
    public static final String CEYLON_ANNOTATION_INSTANTIATION_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.AnnotationInstantiation";
    public static final String CEYLON_FINAL_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Final";
    ...
    public static final String CEYLON_ANNOTATION_INSTANTIATION_TREE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.AnnotationInstantiationTree";
    public static final String CEYLON_STRING_VALUE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.StringValue";
    public static final String CEYLON_STRING_EXPRS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.StringExprs";
    public static final String CEYLON_BOOLEAN_VALUE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.BooleanValue";
    public static final String CEYLON_BOOLEAN_EXPRS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.BooleanExprs";
    public static final String CEYLON_INTEGER_VALUE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.IntegerValue";
    public static final String CEYLON_INTEGER_EXPRS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.IntegerExprs";
    public static final String CEYLON_CHARACTER_VALUE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.CharacterValue";
    public static final String CEYLON_CHARACTER_EXPRS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.CharacterExprs";
    public static final String CEYLON_FLOAT_VALUE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.FloatValue";
    public static final String CEYLON_FLOAT_EXPRS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.FloatExprs";
    public static final String CEYLON_OBJECT_VALUE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.ObjectValue";
    public static final String CEYLON_OBJECT_EXPRS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.ObjectExprs";
    public static final String CEYLON_DECLARATION_VALUE_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.DeclarationValue";
    public static final String CEYLON_DECLARATION_EXPRS_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.DeclarationExprs";
    private static final String CEYLON_TRANSIENT_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Transient";
    private static final String CEYLON_DYNAMIC_ANNOTATION = "org.eclipse.ceylon.compiler.java.metadata.Dynamic";
...
//    private static final TypeMirror CEYLON_FUNCTION_DECLARATION_TYPE = simpleCeylonObjectType("ceylon.language.meta.declaration.FunctionDeclaration");
    ...
    private static final TypeMirror CEYLON_REIFIED_TYPE_TYPE = simpleCeylonObjectType("org.eclipse.ceylon.compiler.java.runtime.model.ReifiedType");
    private static final TypeMirror CEYLON_SERIALIZABLE_TYPE = simpleCeylonObjectType("org.eclipse.ceylon.compiler.java.runtime.serialization.Serializable");
    private static final TypeMirror CEYLON_TYPE_DESCRIPTOR_TYPE = simpleCeylonObjectType("org.eclipse.ceylon.compiler.java.runtime.model.TypeDescriptor");
...
//    private static final TypeMirror ERROR_TYPE = simpleCeylonObjectType("java.lang.Error");
    ...
    private static final String CEYLON_BYTE_ARRAY = "org.eclipse.ceylon.compiler.java.language.ByteArray";
    private static final String CEYLON_SHORT_ARRAY = "org.eclipse.ceylon.compiler.java.language.ShortArray";
    private static final String CEYLON_INT_ARRAY = "org.eclipse.ceylon.compiler.java.language.IntArray";
    private static final String CEYLON_LONG_ARRAY = "org.eclipse.ceylon.compiler.java.language.LongArray";
    private static final String CEYLON_FLOAT_ARRAY = "org.eclipse.ceylon.compiler.java.language.FloatArray";
    private static final String CEYLON_DOUBLE_ARRAY = "org.eclipse.ceylon.compiler.java.language.DoubleArray";
    private static final String CEYLON_CHAR_ARRAY = "org.eclipse.ceylon.compiler.java.language.CharArray";
    private static final String CEYLON_BOOLEAN_ARRAY = "org.eclipse.ceylon.compiler.java.language.BooleanArray";
    private static final String CEYLON_OBJECT_ARRAY = "org.eclipse.ceylon.compiler.java.language.ObjectArray";
    ...
    private static final String CEYLON_INTEROP_UTILS = "org.eclipse.ceylon.compiler.java.language.Types";
    ...
    private static final String CEYLON_INTEROP_TRANSIENT_ANNOTATION = "org.eclipse.ceylon.compiler.java.language.transient";
    private static final String CEYLON_INTEROP_VOLATILE_ANNOTATION = "org.eclipse.ceylon.compiler.java.language.volatile";
    private static final String CEYLON_INTEROP_SYNCHRONIZED_ANNOTATION = "org.eclipse.ceylon.compiler.java.language.synchronized";
    private static final String CEYLON_INTEROP_NATIVE_ANNOTATION = "org.eclipse.ceylon.compiler.java.language.native";
    private static final String CEYLON_INTEROP_STRICTFP_ANNOTATION = "org.eclipse.ceylon.compiler.java.language.strictfp";
    private static final String CEYLON_INTEROP_OVERLOADED_ANNOTATION = "org.eclipse.ceylon.compiler.java.language.overloaded";
    private static final String CEYLON_INTEROP_NONBEAN_ANNOTATION = "org.eclipse.ceylon.compiler.java.language.nonbean";

    private static final String CEYLON_INTEROP_TRANSIENT_TYPE = "org.eclipse.ceylon.compiler.java.language.Transient";
    private static final String CEYLON_INTEROP_VOLATILE_TYPE = "org.eclipse.ceylon.compiler.java.language.Volatile";
    private static final String CEYLON_INTEROP_SYNCHRONIZED_TYPE = "org.eclipse.ceylon.compiler.java.language.Synchronized";
    private static final String CEYLON_INTEROP_NATIVE_TYPE = "org.eclipse.ceylon.compiler.java.language.Native";
    private static final String CEYLON_INTEROP_STRICTFP_TYPE = "org.eclipse.ceylon.compiler.java.language.Strictfp";
    private static final String CEYLON_INTEROP_OVERLOADED_TYPE = "org.eclipse.ceylon.compiler.java.language.Overloaded";
    private static final String CEYLON_INTEROP_NONBEAN_TYPE = "org.eclipse.ceylon.compiler.java.language.Nonbean";
            ...
            public ClassMirror call() throws Exception {
                ...
                try{
                    ...
                    if (JAVA_LANG_OBJECT_ARRAY.equals(name)
                        ...
                        name = "org.eclipse.ceylon.compiler.java.language" + name.substring(9);
    ...
    public Module lookupModuleByPackageName(String packageName) {
        ...
        if(packageName.startsWith("org.eclipse.ceylon.compiler.java.runtime")
                || packageName.startsWith("org.eclipse.ceylon.compiler.java.language")
                || packageName.startsWith("org.eclipse.ceylon.compiler.java.metadata")){
...
//        module.setLabel(label);
    ...
    private boolean allReifiedTypeParameters(List<VariableMirror> list) {
        for (VariableMirror v : list) {
            if ("org.eclipse.ceylon.compiler.java.runtime.model.TypeDescriptor"
...
//            List<VariableMirror> functionalParameters = functionalMethod.getParameters();
    ...
    private void markUntrustedType(TypedDeclaration decl, AnnotatedMirror typedMirror, TypeMirror type) {
        ...
        if ("org.eclipse.ceylon.compiler.java.test.structure.klass::IterableSequence.sequence".equals(decl.getQualifiedNameString())
    ...
    public ClassMirror[] getClassMirrorsToRemove(org.eclipse.ceylon.model.typechecker.model.Declaration declaration) {
...
//                                      System.out.println("No non-null declaration removed from the second cache for key : " + key);
    ...
    private boolean isImportedSpecialRules(Module moduleScope, Module importedModule) {
        ...
        if(ModelUtil.equalModules(moduleScope, getLanguageModule())){
            ...
            if((importedModuleName.equals("org.eclipse.ceylon.compiler.java")
                || importedModuleName.equals("org.eclipse.ceylon.typechecker")
                || importedModuleName.equals("org.eclipse.ceylon.common")
                || importedModuleName.equals("org.eclipse.ceylon.model")
                || importedModuleName.equals("org.eclipse.ceylon.module-resolver"))
