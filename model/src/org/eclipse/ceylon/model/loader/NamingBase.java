...
import static org.eclipse.ceylon.common.JVMModuleUtil.quoteIfJavaKeyword;
import static org.eclipse.ceylon.model.loader.JvmBackendUtil.isBoxedVariable;
import static org.eclipse.ceylon.model.loader.JvmBackendUtil.isValue;
import static org.eclipse.ceylon.model.typechecker.model.ModelUtil.getConstructedClass;
import static org.eclipse.ceylon.model.typechecker.model.ModelUtil.isLocalToInitializer;
    ...
    public static String getGetterName(Declaration decl, boolean indirect) {
        ...
        if (decl instanceof Value) {
            ...
            enumeratedConstructor = type != null
                && type.getDeclaration() instanceof org.eclipse.ceylon.model.typechecker.model.Constructor;
        }
