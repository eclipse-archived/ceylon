 ...
 */
public class LazyConstructorFactoryFunction extends Function implements LazyElement, LocalDeclarationContainer {

    public final LazyClass klass;
    ...
    public LazyConstructorFactoryFunction(LazyClass klass, ModelCompleter completer) {
        this.klass = klass;
        this.completer = completer;
        setName(NamingBase.getJavaBeanName(klass.getName()));
    }
...
//        load();
    ...
    public LazyClass getFactoryClass(){
        return klass;
    }
}
