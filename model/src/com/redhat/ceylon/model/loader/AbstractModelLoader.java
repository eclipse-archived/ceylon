...
//    private static final TypeMirror ERROR_TYPE = simpleCeylonObjectType("java.lang.Error");
    ...
    protected Module loadLanguageModuleAndPackage() {
        ...
        languageModule.addImport(new ModuleImport(null, findOrCreateModule("com.redhat.ceylon.common", Versions.CEYLON_VERSION_NUMBER), false, true, Backend.Java));
        languageModule.addImport(new ModuleImport(null, findOrCreateModule("com.redhat.ceylon.model", Versions.CEYLON_VERSION_NUMBER), false, true, Backend.Java));
